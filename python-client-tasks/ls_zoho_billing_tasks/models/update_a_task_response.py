...
class UpdateATaskResponse(BaseModel):
    """
    UpdateATaskResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    task: Optional[ListTasksResponseTasksInner] = None
    __properties: ClassVar[List[str]] = ["code", "message", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task": ListTasksResponseTasksInner.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
        return _obj
