...
class GetATaskResponse(BaseModel):
    """
    GetATaskResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    task: Optional[GetATaskResponseTask] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task": GetATaskResponseTask.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
        return _obj
