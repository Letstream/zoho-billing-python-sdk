...
class UpdateATaskRequest(BaseModel):
    """
    UpdateATaskRequest
    """ # noqa: E501
    task_name: StrictStr = Field(description="The name of the task. <code>Maximum length [100]</code>")
    ...
    budget_hours: Optional[StrictInt] = Field(default=None, description="Task budget hours.")
