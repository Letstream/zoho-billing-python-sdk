...
class TestAddATaskResponse(unittest.TestCase):
    """AddATaskResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddATaskResponse:
        """Test AddATaskResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddATaskResponse`
        """
        model = AddATaskResponse()
        if include_optional:
            return AddATaskResponse(
                code = 0,
                message = 'The task has been added.',
                task = ls_zoho_billing_tasks.models.task_response.task-response(
