...
class TestListTasksResponseTasksInner(unittest.TestCase):
    """ListTasksResponseTasksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTasksResponseTasksInner:
        """Test ListTasksResponseTasksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTasksResponseTasksInner`
        """
        model = ListTasksResponseTasksInner()
        if include_optional:
            return ListTasksResponseTasksInner(
    ...
    def testListTasksResponseTasksInner(self):
        """Test ListTasksResponseTasksInner"""
