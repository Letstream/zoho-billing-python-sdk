...
class TestCreateARecurringExpenseRequest(unittest.TestCase):
    """CreateARecurringExpenseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateARecurringExpenseRequest:
        """Test CreateARecurringExpenseRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateARecurringExpenseRequest`
        """
        model = CreateARecurringExpenseRequest()
        if include_optional:
            return CreateARecurringExpenseRequest(
    ...
    def testCreateARecurringExpenseRequest(self):
        """Test CreateARecurringExpenseRequest"""
