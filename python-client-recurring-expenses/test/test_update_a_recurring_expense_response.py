...
class TestUpdateARecurringExpenseResponse(unittest.TestCase):
    """UpdateARecurringExpenseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateARecurringExpenseResponse:
        """Test UpdateARecurringExpenseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateARecurringExpenseResponse`
        """
        model = UpdateARecurringExpenseResponse()
        if include_optional:
            return UpdateARecurringExpenseResponse(
                code = 0,
                message = 'Recurring expense information has been updated',
                recurring_expense = ls_zoho_billing_recurring_expenses.models.update_a_recurring_expense_response_recurring_expense.update_a_recurring_expense_response_recurring_expense(
    ...
    def testUpdateARecurringExpenseResponse(self):
        """Test UpdateARecurringExpenseResponse"""
