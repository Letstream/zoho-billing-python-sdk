...
class TestListRecurringExpensesResponse(unittest.TestCase):
    """ListRecurringExpensesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRecurringExpensesResponse:
        """Test ListRecurringExpensesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRecurringExpensesResponse`
        """
        model = ListRecurringExpensesResponse()
        if include_optional:
            return ListRecurringExpensesResponse(
                code = 0,
                message = 'success',
                recurring_expenses = [
                    ls_zoho_billing_recurring_expenses.models.list_recurring_expenses_response_recurring_expenses_inner.list_recurring_expenses_response_recurring_expenses_inner(
    ...
    def testListRecurringExpensesResponse(self):
        """Test ListRecurringExpensesResponse"""
