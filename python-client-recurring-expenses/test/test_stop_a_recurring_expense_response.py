...
class TestStopARecurringExpenseResponse(unittest.TestCase):
    """StopARecurringExpenseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StopARecurringExpenseResponse:
        """Test StopARecurringExpenseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StopARecurringExpenseResponse`
        """
        model = StopARecurringExpenseResponse()
        if include_optional:
            return StopARecurringExpenseResponse(
                code = 0,
    ...
    def testStopARecurringExpenseResponse(self):
        """Test StopARecurringExpenseResponse"""
