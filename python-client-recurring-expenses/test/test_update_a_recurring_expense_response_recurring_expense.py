...
class TestUpdateARecurringExpenseResponseRecurringExpense(unittest.TestCase):
    """UpdateARecurringExpenseResponseRecurringExpense unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateARecurringExpenseResponseRecurringExpense:
        """Test UpdateARecurringExpenseResponseRecurringExpense
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateARecurringExpenseResponseRecurringExpense`
        """
        model = UpdateARecurringExpenseResponseRecurringExpense()
        if include_optional:
            return UpdateARecurringExpenseResponseRecurringExpense(
    ...
    def testUpdateARecurringExpenseResponseRecurringExpense(self):
        """Test UpdateARecurringExpenseResponseRecurringExpense"""
