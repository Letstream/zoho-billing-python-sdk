...
class TestResumeARecurringExpenseResponse(unittest.TestCase):
    """ResumeARecurringExpenseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResumeARecurringExpenseResponse:
        """Test ResumeARecurringExpenseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResumeARecurringExpenseResponse`
        """
        model = ResumeARecurringExpenseResponse()
        if include_optional:
            return ResumeARecurringExpenseResponse(
                code = 0,
    ...
    def testResumeARecurringExpenseResponse(self):
        """Test ResumeARecurringExpenseResponse"""
