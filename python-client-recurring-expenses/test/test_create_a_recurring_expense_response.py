...
class TestCreateARecurringExpenseResponse(unittest.TestCase):
    """CreateARecurringExpenseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateARecurringExpenseResponse:
        """Test CreateARecurringExpenseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateARecurringExpenseResponse`
        """
        model = CreateARecurringExpenseResponse()
        if include_optional:
            return CreateARecurringExpenseResponse(
                code = 0,
                message = 'The recurring expense has been created',
                recurring_expense = ls_zoho_billing_recurring_expenses.models.recurring_expense_response.recurring_expense-response(
    ...
    def testCreateARecurringExpenseResponse(self):
        """Test CreateARecurringExpenseResponse"""
