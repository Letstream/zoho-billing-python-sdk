...
class UpdateARecurringExpenseResponseRecurringExpense(BaseModel):
    """
    ...
    amount: Optional[StrictStr] = Field(default=None, description="Recurring Expense amount.")
    ...
    __properties: ClassVar[List[str]] = ["account_id", "recurrence_name", "start_date", "end_date", "is_pre_gst", "source_of_supply", "destination_of_supply", "gst_no", "gst_treatment", "destination_of_supply_state", "hsn_or_sac", "vat_treatment", "reverse_charge_tax_id", "reverse_charge_tax_name", "reverse_charge_tax_percentage", "reverse_charge_tax_amount", "is_reverse_charge_applied", "acquisition_vat_total", "reverse_charge_vat_total", "acquisition_vat_summary", "reverse_charge_vat_summary", "recurrence_frequency", "repeat_every", "amount", "total", "sub_total", "bcy_total", "product_type", "acquisition_vat_id", "reverse_charge_vat_id", "tax_id", "tax_name", "tax_percentage", "created_time", "last_modified_time", "is_inclusive_tax", "is_billable", "customer_id", "currency_id", "exchange_rate", "project_id", "project_name", "custom_fields", "line_item"]
