...
class LineItemsInner(BaseModel):
    ...
    tax_exemption_code: Optional[StrictStr] = Field(default=None, description="Enter the code for tax exemption")
    tax_exemption_id: Optional[StrictStr] = Field(default=None, description="Enter ID of the tax exemption")
