...
class ListChildExpensesCreatedResponse(BaseModel):
    """
    ListChildExpensesCreatedResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    expensehistory: Optional[List[ListChildExpensesCreatedResponseExpensehistoryInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "expensehistory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in expensehistory (list)
        _items = []
        if self.expensehistory:
            for _item_expensehistory in self.expensehistory:
                if _item_expensehistory:
                    _items.append(_item_expensehistory.to_dict())
            _dict['expensehistory'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expensehistory": [ListChildExpensesCreatedResponseExpensehistoryInner.from_dict(_item) for _item in obj["expensehistory"]] if obj.get("expensehistory") is not None else None
        })
        return _obj
