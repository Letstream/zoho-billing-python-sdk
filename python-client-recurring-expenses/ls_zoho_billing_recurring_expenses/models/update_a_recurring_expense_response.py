...
class UpdateARecurringExpenseResponse(BaseModel):
    """
    UpdateARecurringExpenseResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    recurring_expense: Optional[UpdateARecurringExpenseResponseRecurringExpense] = None
    __properties: ClassVar[List[str]] = ["code", "message", "recurring_expense"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recurring_expense
        if self.recurring_expense:
            _dict['recurring_expense'] = self.recurring_expense.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recurring_expense": UpdateARecurringExpenseResponseRecurringExpense.from_dict(obj["recurring_expense"]) if obj.get("recurring_expense") is not None else None
        })
        return _obj
