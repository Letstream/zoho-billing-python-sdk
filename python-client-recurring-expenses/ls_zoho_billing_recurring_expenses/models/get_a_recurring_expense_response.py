...
class GetARecurringExpenseResponse(BaseModel):
    """
    GetARecurringExpenseResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    recurring_expense: Optional[GetARecurringExpenseResponseRecurringExpense] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recurring_expense": GetARecurringExpenseResponseRecurringExpense.from_dict(obj["recurring_expense"]) if obj.get("recurring_expense") is not None else None
        })
        return _obj
