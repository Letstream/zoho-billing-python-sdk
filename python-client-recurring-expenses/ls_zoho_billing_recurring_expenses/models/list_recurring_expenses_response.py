...
class ListRecurringExpensesResponse(BaseModel):
    """
    ListRecurringExpensesResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    recurring_expenses: Optional[List[ListRecurringExpensesResponseRecurringExpensesInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "recurring_expenses"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in recurring_expenses (list)
        _items = []
        if self.recurring_expenses:
            for _item_recurring_expenses in self.recurring_expenses:
                if _item_recurring_expenses:
                    _items.append(_item_recurring_expenses.to_dict())
            _dict['recurring_expenses'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recurring_expenses": [ListRecurringExpensesResponseRecurringExpensesInner.from_dict(_item) for _item in obj["recurring_expenses"]] if obj.get("recurring_expenses") is not None else None
        })
        return _obj
