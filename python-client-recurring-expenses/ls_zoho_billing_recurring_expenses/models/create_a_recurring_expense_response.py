...
class CreateARecurringExpenseResponse(BaseModel):
    """
    CreateARecurringExpenseResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    recurring_expense: Optional[RecurringExpenseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recurring_expense": RecurringExpenseResponse.from_dict(obj["recurring_expense"]) if obj.get("recurring_expense") is not None else None
        })
        return _obj
