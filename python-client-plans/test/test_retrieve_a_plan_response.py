...
class TestRetrieveAPlanResponse(unittest.TestCase):
    """RetrieveAPlanResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveAPlanResponse:
        """Test RetrieveAPlanResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveAPlanResponse`
        """
        model = RetrieveAPlanResponse()
        if include_optional:
            return RetrieveAPlanResponse(
                code = 0,
                message = 'success',
                plan = ls_zoho_billing_plans.models.retrieve_a_plan_response_plan.retrieve_a_plan_response_plan(
    ...
    def testRetrieveAPlanResponse(self):
        """Test RetrieveAPlanResponse"""
