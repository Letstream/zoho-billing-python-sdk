...
class TestUpdateAPlanResponsePlan(unittest.TestCase):
    """UpdateAPlanResponsePlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAPlanResponsePlan:
        """Test UpdateAPlanResponsePlan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAPlanResponsePlan`
        """
        model = UpdateAPlanResponsePlan()
        if include_optional:
            return UpdateAPlanResponsePlan(
    ...
    def testUpdateAPlanResponsePlan(self):
        """Test UpdateAPlanResponsePlan"""
