...
class TestCreateAPlanResponse(unittest.TestCase):
    """CreateAPlanResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAPlanResponse:
        """Test CreateAPlanResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAPlanResponse`
        """
        model = CreateAPlanResponse()
        if include_optional:
            return CreateAPlanResponse(
                code = 0,
                message = 'The plan has been created.',
                plan = ls_zoho_billing_plans.models.plan_response.plan-response(
                    ...
                    addons = [
                        ls_zoho_billing_plans.models.plan_response_addons_inner.plan_response_addons_inner(
    ...
    def testCreateAPlanResponse(self):
        """Test CreateAPlanResponse"""
