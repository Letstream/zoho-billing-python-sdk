...
class UpdateAPlanResponse(BaseModel):
    """
    UpdateAPlanResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    plan: Optional[UpdateAPlanResponsePlan] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plan": UpdateAPlanResponsePlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
