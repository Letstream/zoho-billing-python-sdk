...
class UpdateAPlanResponsePlan(BaseModel):
    """
    ...
    tags: Optional[List[UpdateAPlanResponsePlanTagsInner]] = None
    custom_fields: Optional[List[UpdateAPlanResponsePlanCustomFieldsInner]] = Field(default=None, description="Custom fields for a Plan.")
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "name", "description", "store_markup_description", "can_charge_setup_fee_immediately", "status", "product_id", "account_id", "account_name", "trial_period", "setup_fee", "setup_fee_account_id", "setup_fee_account_name", "tags", "custom_fields", "recurring_price", "unit", "interval", "interval_unit", "billing_cycles", "url", "tax_id", "product_type", "hsn_or_sac", "sat_item_key_code", "unitkey_code", "item_tax_preferences", "created_time", "updated_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": [UpdateAPlanResponsePlanTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
            "custom_fields": [UpdateAPlanResponsePlanCustomFieldsInner.from_dict(_item) for _item in obj["custom_fields"]] if obj.get("custom_fields") is not None else None,
