...
class PlanResponse(BaseModel):
    ...
    addons: Optional[List[PlanResponseAddonsInner]] = Field(default=None, description="List of addons that the plan is associated with. It holds the list of objects with <code>addon_code</code> and <code>name</code> as properties.")
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "name", "description", "store_markup_description", "status", "product_id", "account_id", "account_name", "tax_id", "trial_period", "setup_fee", "setup_fee_account_id", "setup_fee_account_name", "tags", "custom_fields", "recurring_price", "unit", "interval", "interval_unit", "billing_cycles", "product_type", "hsn_or_sac", "sat_item_key_code", "unitkey_code", "item_tax_preferences", "addons", "url", "created_time", "updated_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addons": [PlanResponseAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None,
            "url": obj.get("url"),
