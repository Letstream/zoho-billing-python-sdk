...
class CreateAPlanRequest(BaseModel):
    """
    CreateAPlanRequest
    """ # noqa: E501
    ...
    custom_fields: Optional[List[CustomFieldsInner]] = Field(default=None, description="Custom fields for a Plan.")
    product_id: StrictStr = Field(description="Product ID to which you want to associate this plan with.")
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "name", "recurring_price", "unit", "interval", "interval_unit", "billing_cycles", "trial_period", "setup_fee", "setup_fee_account_id", "tags", "custom_fields", "product_id", "product_type", "hsn_or_sac", "sat_item_key_code", "unitkey_code", "item_tax_preferences", "tax_id", "is_taxable", "tax_exemption_id", "tax_exemption_code", "description", "store_markup_description", "can_charge_setup_fee_immediately"]
