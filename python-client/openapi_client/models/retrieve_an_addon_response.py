...
class RetrieveAnAddonResponse(BaseModel):
    """
    RetrieveAnAddonResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    addon: Optional[RetrieveAnAddonResponseAddon] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addon": RetrieveAnAddonResponseAddon.from_dict(obj["addon"]) if obj.get("addon") is not None else None
        })
        return _obj
