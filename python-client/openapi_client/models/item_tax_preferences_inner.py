...
class ItemTaxPreferencesInner(BaseModel):
    ...
    """ # noqa: E501
    tax_specification: Optional[StrictStr] = Field(default=None, description="Tax specification for the addon. It can be either <code>inter</code> or <code>intra</code>.")
