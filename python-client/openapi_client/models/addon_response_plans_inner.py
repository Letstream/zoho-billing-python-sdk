...
class AddonResponsePlansInner(BaseModel):
    """
    AddonResponsePlansInner
    """ # noqa: E501
    plan_code: Optional[StrictStr] = Field(default=None, description="The plan code of the plan to which the addon is to be applied.")
    name: Optional[Any] = Field(default=None, description="The name of the plan.")
