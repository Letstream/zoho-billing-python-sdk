    ...
    def make_instance(self, include_optional) -> UpdateAnAddonRequest:
        ...
        if include_optional:
            return UpdateAnAddonRequest(
                ...
                pricing_scheme = 'unit',
                price_brackets = [
                    openapi_client.models.update_an_addon_request_price_brackets_inner.update_an_addon_request_price_brackets_inner(
                        start_quantity = 1, 
                        end_quantity = 50, 
                        price = 10, )
                    ],
                ...
                tags = [
                    openapi_client.models.update_an_addon_request_tags_inner.update_an_addon_request_tags_inner(
                ...
                plans = [
                    openapi_client.models.update_an_addon_request_plans_inner.update_an_addon_request_plans_inner(
