...
class TestListAllAddonsResponseAddonsInnerTagsInner(unittest.TestCase):
    """ListAllAddonsResponseAddonsInnerTagsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAllAddonsResponseAddonsInnerTagsInner:
        """Test ListAllAddonsResponseAddonsInnerTagsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAllAddonsResponseAddonsInnerTagsInner`
        """
        model = ListAllAddonsResponseAddonsInnerTagsInner()
        if include_optional:
            return ListAllAddonsResponseAddonsInnerTagsInner(
    ...
    def testListAllAddonsResponseAddonsInnerTagsInner(self):
        """Test ListAllAddonsResponseAddonsInnerTagsInner"""
