    ...
    def make_instance(self, include_optional) -> RetrieveAnAddonResponse:
        ...
        if include_optional:
            return RetrieveAnAddonResponse(
                code = 0,
                message = 'success',
                addon = openapi_client.models.retrieve_an_addon_response_addon.retrieve_an_addon_response_addon(
                    ...
                    tags = [
                        openapi_client.models.addon_response_tags_inner.addon_response_tags_inner(
