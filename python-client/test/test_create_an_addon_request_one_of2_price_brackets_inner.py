...
class TestCreateAnAddonRequestOneOf2PriceBracketsInner(unittest.TestCase):
    """CreateAnAddonRequestOneOf2PriceBracketsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnAddonRequestOneOf2PriceBracketsInner:
        """Test CreateAnAddonRequestOneOf2PriceBracketsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnAddonRequestOneOf2PriceBracketsInner`
        """
        model = CreateAnAddonRequestOneOf2PriceBracketsInner()
        if include_optional:
            return CreateAnAddonRequestOneOf2PriceBracketsInner(
                price = 10
            )
        else:
            return CreateAnAddonRequestOneOf2PriceBracketsInner(
    ...
    def testCreateAnAddonRequestOneOf2PriceBracketsInner(self):
        """Test CreateAnAddonRequestOneOf2PriceBracketsInner"""
