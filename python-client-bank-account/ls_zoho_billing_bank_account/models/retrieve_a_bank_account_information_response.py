...
class RetrieveABankAccountInformationResponse(BaseModel):
    """
    RetrieveABankAccountInformationResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    bank_accounts: Optional[List[BankAccountsResponse]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "bank_accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bank_accounts": [BankAccountsResponse.from_dict(_item) for _item in obj["bank_accounts"]] if obj.get("bank_accounts") is not None else None
        })
        return _obj
