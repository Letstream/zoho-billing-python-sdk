...
class TestTimeEntryResponse(unittest.TestCase):
    """TimeEntryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryResponse:
        """Test TimeEntryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryResponse`
        """
        model = TimeEntryResponse()
        if include_optional:
    ...
    def testTimeEntryResponse(self):
        """Test TimeEntryResponse"""
