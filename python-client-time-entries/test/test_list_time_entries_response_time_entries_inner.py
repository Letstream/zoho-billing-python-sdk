...
class TestListTimeEntriesResponseTimeEntriesInner(unittest.TestCase):
    """ListTimeEntriesResponseTimeEntriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTimeEntriesResponseTimeEntriesInner:
        """Test ListTimeEntriesResponseTimeEntriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTimeEntriesResponseTimeEntriesInner`
        """
        model = ListTimeEntriesResponseTimeEntriesInner()
        if include_optional:
            return ListTimeEntriesResponseTimeEntriesInner(
    ...
    def testListTimeEntriesResponseTimeEntriesInner(self):
        """Test ListTimeEntriesResponseTimeEntriesInner"""
