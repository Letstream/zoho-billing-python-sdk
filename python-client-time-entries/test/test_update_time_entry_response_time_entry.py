...
class TestUpdateTimeEntryResponseTimeEntry(unittest.TestCase):
    """UpdateTimeEntryResponseTimeEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTimeEntryResponseTimeEntry:
        """Test UpdateTimeEntryResponseTimeEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTimeEntryResponseTimeEntry`
        """
        model = UpdateTimeEntryResponseTimeEntry()
        if include_optional:
            return UpdateTimeEntryResponseTimeEntry(
    ...
    def testUpdateTimeEntryResponseTimeEntry(self):
        """Test UpdateTimeEntryResponseTimeEntry"""
