...
class TestDeleteTimeEntryResponse(unittest.TestCase):
    """DeleteTimeEntryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteTimeEntryResponse:
        """Test DeleteTimeEntryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteTimeEntryResponse`
        """
        model = DeleteTimeEntryResponse()
        if include_optional:
    ...
    def testDeleteTimeEntryResponse(self):
        """Test DeleteTimeEntryResponse"""
