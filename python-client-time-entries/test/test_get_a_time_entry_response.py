...
class TestGetATimeEntryResponse(unittest.TestCase):
    """GetATimeEntryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetATimeEntryResponse:
        """Test GetATimeEntryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetATimeEntryResponse`
        """
        model = GetATimeEntryResponse()
        if include_optional:
            return GetATimeEntryResponse(
                code = 0,
                message = 'success',
    ...
    def testGetATimeEntryResponse(self):
        """Test GetATimeEntryResponse"""
