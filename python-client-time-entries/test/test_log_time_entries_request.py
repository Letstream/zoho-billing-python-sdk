...
class TestLogTimeEntriesRequest(unittest.TestCase):
    """LogTimeEntriesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogTimeEntriesRequest:
        """Test LogTimeEntriesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogTimeEntriesRequest`
        """
        model = LogTimeEntriesRequest()
        if include_optional:
            return LogTimeEntriesRequest(
    ...
    def testLogTimeEntriesRequest(self):
        """Test LogTimeEntriesRequest"""
