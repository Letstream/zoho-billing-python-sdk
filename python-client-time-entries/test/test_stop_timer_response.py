...
class TestStopTimerResponse(unittest.TestCase):
    """StopTimerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StopTimerResponse:
        """Test StopTimerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StopTimerResponse`
        """
        model = StopTimerResponse()
        if include_optional:
    ...
    def testStopTimerResponse(self):
        """Test StopTimerResponse"""
