...
class TestStartTimerResponse(unittest.TestCase):
    """StartTimerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartTimerResponse:
        """Test StartTimerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartTimerResponse`
        """
        model = StartTimerResponse()
        if include_optional:
    ...
    def testStartTimerResponse(self):
        """Test StartTimerResponse"""
