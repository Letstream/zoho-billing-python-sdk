...
class TestGetTimerResponse(unittest.TestCase):
    """GetTimerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTimerResponse:
        """Test GetTimerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTimerResponse`
        """
        model = GetTimerResponse()
        if include_optional:
