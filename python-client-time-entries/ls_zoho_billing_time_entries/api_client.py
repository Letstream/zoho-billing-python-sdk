...
from ls_zoho_billing_time_entries.configuration import Configuration
from ls_zoho_billing_time_entries.api_response import ApiResponse, T as ApiResponseT
import ls_zoho_billing_time_entries.models
from ls_zoho_billing_time_entries import rest
from ls_zoho_billing_time_entries.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ls_zoho_billing_time_entries.models, klass)
