...
class ListTimeEntriesResponse(BaseModel):
    """
    ListTimeEntriesResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    time_entries: Optional[List[ListTimeEntriesResponseTimeEntriesInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "time_entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time_entries": [ListTimeEntriesResponseTimeEntriesInner.from_dict(_item) for _item in obj["time_entries"]] if obj.get("time_entries") is not None else None
        })
        return _obj
