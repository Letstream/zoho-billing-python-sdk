...
class CreateAnCouponRequest(BaseModel):
    """
    CreateAnCouponRequest
    """ # noqa: E501
    coupon_code: StrictStr = Field(description="Unique string of your choice which lets you identify this coupon.")
    ...
    type: StrictStr = Field(description="This indicates whether the coupon is to be applied only once, particular number of times or every time an invoice is raised for the subscription. It can either be <code>one_time</code>, <code>duration</code>, <code>forever</code>.")
    duration: StrictInt = Field(description="This indicates the number of times the coupon has to applied to the invoices generated for a particular subscription.")
    discount_by: StrictStr = Field(description="Percentage off or Flat rate discounts can be offered. The value can either be <code>flat</code> or <code>percentage</code>.")
    ...
    product_id: StrictStr = Field(description="The Product ID of the product for which the coupon has to be created.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plans": [CreateAnCouponRequestPlansInner.from_dict(_item) for _item in obj["plans"]] if obj.get("plans") is not None else None,
            "apply_to_addons": obj.get("apply_to_addons"),
            "addons": [CreateAnCouponRequestAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None
        })
        return _obj
