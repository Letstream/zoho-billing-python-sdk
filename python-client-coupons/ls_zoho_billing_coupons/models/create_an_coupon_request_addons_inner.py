...
class CreateAnCouponRequestAddonsInner(BaseModel):
    """
    CreateAnCouponRequestAddonsInner
    """ # noqa: E501
    addon_code: StrictStr = Field(description="The addon code of the addon to which the coupon is to be applied.")
    __properties: ClassVar[List[str]] = ["addon_code"]
