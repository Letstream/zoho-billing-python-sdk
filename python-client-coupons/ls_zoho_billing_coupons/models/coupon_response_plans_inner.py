...
class CouponResponsePlansInner(BaseModel):
    """
    CouponResponsePlansInner
    """ # noqa: E501
    plan_code: Optional[StrictStr] = Field(default=None, description="The plan code of the plan to which the coupon is to be applied.")
    name: Optional[Any] = Field(default=None, description="Plan to which the coupon is to be applied.")
    __properties: ClassVar[List[str]] = ["plan_code", "name"]
