...
class RetrieveACouponResponse(BaseModel):
    """
    RetrieveACouponResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    coupon: Optional[RetrieveACouponResponseCoupon] = None
    __properties: ClassVar[List[str]] = ["code", "message", "coupon"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "coupon": RetrieveACouponResponseCoupon.from_dict(obj["coupon"]) if obj.get("coupon") is not None else None
        })
        return _obj
