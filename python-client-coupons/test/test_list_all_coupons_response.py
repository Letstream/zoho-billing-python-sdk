...
class TestListAllCouponsResponse(unittest.TestCase):
    """ListAllCouponsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAllCouponsResponse:
        """Test ListAllCouponsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAllCouponsResponse`
        """
        model = ListAllCouponsResponse()
        if include_optional:
            return ListAllCouponsResponse(
                code = 0,
                message = 'success',
                coupons = [
                    ls_zoho_billing_coupons.models.list_all_coupons_response_coupons_inner.list_all_coupons_response_coupons_inner(
    ...
    def testListAllCouponsResponse(self):
        """Test ListAllCouponsResponse"""
