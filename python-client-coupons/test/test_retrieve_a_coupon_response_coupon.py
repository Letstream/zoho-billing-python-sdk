...
class TestRetrieveACouponResponseCoupon(unittest.TestCase):
    """RetrieveACouponResponseCoupon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveACouponResponseCoupon:
        """Test RetrieveACouponResponseCoupon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveACouponResponseCoupon`
        """
        model = RetrieveACouponResponseCoupon()
        if include_optional:
            return RetrieveACouponResponseCoupon(
    ...
    def testRetrieveACouponResponseCoupon(self):
        """Test RetrieveACouponResponseCoupon"""
