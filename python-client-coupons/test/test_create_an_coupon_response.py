...
class TestCreateAnCouponResponse(unittest.TestCase):
    """CreateAnCouponResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnCouponResponse:
        """Test CreateAnCouponResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnCouponResponse`
        """
        model = CreateAnCouponResponse()
        if include_optional:
            return CreateAnCouponResponse(
                code = 0,
                message = 'The coupon has been created',
                coupon = ls_zoho_billing_coupons.models.coupon_response.coupon-response(
    ...
    def testCreateAnCouponResponse(self):
        """Test CreateAnCouponResponse"""
