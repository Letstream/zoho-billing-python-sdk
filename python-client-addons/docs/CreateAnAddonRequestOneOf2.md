...
**price_brackets** | [**List[CreateAnAddonRequestOneOf2PriceBracketsInner]**](CreateAnAddonRequestOneOf2PriceBracketsInner.md) | Array of objects which contains the start quantity, end quantity and price | 
...
json = "{}"
# create an instance of CreateAnAddonRequestOneOf2 from a JSON string
create_an_addon_request_one_of2_instance = CreateAnAddonRequestOneOf2.from_json(json)
# print the JSON string representation of the object
print(CreateAnAddonRequestOneOf2.to_json())

# convert the object into a dict
create_an_addon_request_one_of2_dict = create_an_addon_request_one_of2_instance.to_dict()
# create an instance of CreateAnAddonRequestOneOf2 from a dict
create_an_addon_request_one_of2_from_dict = CreateAnAddonRequestOneOf2.from_dict(create_an_addon_request_one_of2_dict)
```
