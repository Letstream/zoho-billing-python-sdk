...
class TestCreateAnAddonResponse(unittest.TestCase):
    """CreateAnAddonResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnAddonResponse:
        """Test CreateAnAddonResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnAddonResponse`
        """
        model = CreateAnAddonResponse()
        if include_optional:
            return CreateAnAddonResponse(
                code = 0,
                message = 'The addon has been created',
                addon = ls_zoho_billing_addons.models.addon_response.addon-response(
    ...
    def testCreateAnAddonResponse(self):
        """Test CreateAnAddonResponse"""
