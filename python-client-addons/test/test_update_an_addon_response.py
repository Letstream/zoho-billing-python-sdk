...
class TestUpdateAnAddonResponse(unittest.TestCase):
    """UpdateAnAddonResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnAddonResponse:
        """Test UpdateAnAddonResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnAddonResponse`
        """
        model = UpdateAnAddonResponse()
        if include_optional:
            return UpdateAnAddonResponse(
                code = 0,
                message = 'The addon details have been updated.',
                addon = ls_zoho_billing_addons.models.update_an_addon_response_addon.update_an_addon_response_addon(
    ...
    def testUpdateAnAddonResponse(self):
        """Test UpdateAnAddonResponse"""
