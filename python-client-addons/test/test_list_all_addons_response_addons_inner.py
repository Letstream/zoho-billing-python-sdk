...
class TestListAllAddonsResponseAddonsInner(unittest.TestCase):
    """ListAllAddonsResponseAddonsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAllAddonsResponseAddonsInner:
        """Test ListAllAddonsResponseAddonsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAllAddonsResponseAddonsInner`
        """
        model = ListAllAddonsResponseAddonsInner()
        if include_optional:
            return ListAllAddonsResponseAddonsInner(
    ...
    def testListAllAddonsResponseAddonsInner(self):
        """Test ListAllAddonsResponseAddonsInner"""
