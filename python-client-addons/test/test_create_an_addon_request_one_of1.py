...
class TestCreateAnAddonRequestOneOf1(unittest.TestCase):
    """CreateAnAddonRequestOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnAddonRequestOneOf1:
        """Test CreateAnAddonRequestOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnAddonRequestOneOf1`
        """
        model = CreateAnAddonRequestOneOf1()
        if include_optional:
            return CreateAnAddonRequestOneOf1(
                addon_code = 'Email-basic',
                name = 'Email addon',
                unit_name = 'Email',
                pricing_scheme = package,
                price_brackets = [
                    ls_zoho_billing_addons.models.create_an_addon_request_one_of_1_price_brackets_inner.create_an_addon_request_oneOf_1_price_brackets_inner(
                        end_quantity = 50, 
                        price = 10, )
                    ],
                type = 'recurring',
    ...
    def testCreateAnAddonRequestOneOf1(self):
        """Test CreateAnAddonRequestOneOf1"""
