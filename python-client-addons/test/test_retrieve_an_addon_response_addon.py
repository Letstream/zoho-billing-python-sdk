...
class TestRetrieveAnAddonResponseAddon(unittest.TestCase):
    """RetrieveAnAddonResponseAddon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveAnAddonResponseAddon:
        """Test RetrieveAnAddonResponseAddon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveAnAddonResponseAddon`
        """
        model = RetrieveAnAddonResponseAddon()
        if include_optional:
            return RetrieveAnAddonResponseAddon(
    ...
    def testRetrieveAnAddonResponseAddon(self):
        """Test RetrieveAnAddonResponseAddon"""
