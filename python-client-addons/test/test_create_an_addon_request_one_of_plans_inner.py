...
class TestCreateAnAddonRequestOneOfPlansInner(unittest.TestCase):
    """CreateAnAddonRequestOneOfPlansInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnAddonRequestOneOfPlansInner:
        """Test CreateAnAddonRequestOneOfPlansInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnAddonRequestOneOfPlansInner`
        """
        model = CreateAnAddonRequestOneOfPlansInner()
        if include_optional:
            return CreateAnAddonRequestOneOfPlansInner(
    ...
    def testCreateAnAddonRequestOneOfPlansInner(self):
        """Test CreateAnAddonRequestOneOfPlansInner"""
