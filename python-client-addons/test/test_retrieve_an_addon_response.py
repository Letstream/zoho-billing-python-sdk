...
class TestRetrieveAnAddonResponse(unittest.TestCase):
    """RetrieveAnAddonResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveAnAddonResponse:
        """Test RetrieveAnAddonResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveAnAddonResponse`
        """
        model = RetrieveAnAddonResponse()
        if include_optional:
            return RetrieveAnAddonResponse(
                code = 0,
                message = 'success',
                addon = ls_zoho_billing_addons.models.retrieve_an_addon_response_addon.retrieve_an_addon_response_addon(
                    ...
                    tags = [
                        ls_zoho_billing_addons.models.addon_response_tags_inner.addon_response_tags_inner(
    ...
    def testRetrieveAnAddonResponse(self):
        """Test RetrieveAnAddonResponse"""
