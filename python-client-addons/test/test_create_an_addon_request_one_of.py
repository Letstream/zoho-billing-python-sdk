...
class TestCreateAnAddonRequestOneOf(unittest.TestCase):
    """CreateAnAddonRequestOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnAddonRequestOneOf:
        """Test CreateAnAddonRequestOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnAddonRequestOneOf`
        """
        model = CreateAnAddonRequestOneOf()
        if include_optional:
            return CreateAnAddonRequestOneOf(
    ...
    def testCreateAnAddonRequestOneOf(self):
        """Test CreateAnAddonRequestOneOf"""
