...
class TestCreateAnAddonRequestOneOf2(unittest.TestCase):
    """CreateAnAddonRequestOneOf2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnAddonRequestOneOf2:
        """Test CreateAnAddonRequestOneOf2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnAddonRequestOneOf2`
        """
        model = CreateAnAddonRequestOneOf2()
        if include_optional:
            return CreateAnAddonRequestOneOf2(
                addon_code = 'Email-basic',
                name = 'Email addon',
                unit_name = 'Email',
                pricing_scheme = unit,
                price_brackets = [
                    ls_zoho_billing_addons.models.create_an_addon_request_one_of_2_price_brackets_inner.create_an_addon_request_oneOf_2_price_brackets_inner(
                        price = 10, )
                    ],
                type = 'recurring',
                interval_unit = 'monthly',
                tags = [
                    ls_zoho_billing_addons.models.tags_inner.tags_inner(
                ...
                plans = [
                    ls_zoho_billing_addons.models.create_an_addon_request_one_of_plans_inner.create_an_addon_request_oneOf_plans_inner(
    ...
    def testCreateAnAddonRequestOneOf2(self):
        """Test CreateAnAddonRequestOneOf2"""
