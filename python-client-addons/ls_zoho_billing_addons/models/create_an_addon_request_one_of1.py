...
class CreateAnAddonRequestOneOf1(BaseModel):
    """
    ...
    price_brackets: List[CreateAnAddonRequestOneOf1PriceBracketsInner] = Field(description="Array of objects which contains the start quantity, end quantity and price")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price_brackets": [CreateAnAddonRequestOneOf1PriceBracketsInner.from_dict(_item) for _item in obj["price_brackets"]] if obj.get("price_brackets") is not None else None,
