...
class UpdateAnAddonResponse(BaseModel):
    """
    UpdateAnAddonResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    addon: Optional[UpdateAnAddonResponseAddon] = None
    __properties: ClassVar[List[str]] = ["code", "message", "addon"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addon": UpdateAnAddonResponseAddon.from_dict(obj["addon"]) if obj.get("addon") is not None else None
        })
        return _obj
