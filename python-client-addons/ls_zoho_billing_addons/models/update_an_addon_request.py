...
class UpdateAnAddonRequest(BaseModel):
    """
    ...
    price_brackets: List[UpdateAnAddonRequestPriceBracketsInner] = Field(description="Array of objects which contains the start quantity, end quantity and price")
    ...
    tags: Optional[List[UpdateAnAddonRequestTagsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price_brackets": [UpdateAnAddonRequestPriceBracketsInner.from_dict(_item) for _item in obj["price_brackets"]] if obj.get("price_brackets") is not None else None,
            ...
            "tags": [UpdateAnAddonRequestTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
            ...
            "plans": [UpdateAnAddonRequestPlansInner.from_dict(_item) for _item in obj["plans"]] if obj.get("plans") is not None else None,
