...
class UpdateAnAddonRequestPriceBracketsInner(BaseModel):
    """
    UpdateAnAddonRequestPriceBracketsInner
    """ # noqa: E501
    start_quantity: StrictInt = Field(description="Lower limit of the addon range.")
    end_quantity: StrictInt = Field(description="Upper limit of the addon range.")
    price: Union[StrictFloat, StrictInt] = Field(description="Per unit cost of the addon for the selected range. For the “package” pricing scheme, this would be the price of the specified quantity of addons.")
