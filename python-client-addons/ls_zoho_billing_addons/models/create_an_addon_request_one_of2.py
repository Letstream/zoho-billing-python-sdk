...
class CreateAnAddonRequestOneOf2(BaseModel):
    """
    ...
    price_brackets: List[CreateAnAddonRequestOneOf2PriceBracketsInner] = Field(description="Array of objects which contains the start quantity, end quantity and price")
    ...
    __properties: ClassVar[List[str]] = ["addon_code", "name", "unit_name", "pricing_scheme", "price_brackets", "type", "interval_unit", "tags", "custom_fields", "applicable_to_all_plans", "plans", "product_id", "description", "store_markup_description", "product_type", "hsn_or_sac", "sat_item_key_code", "unitkey_code", "item_tax_preferences", "tax_id", "tax_exemption_id", "tax_exemption_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price_brackets": [CreateAnAddonRequestOneOf2PriceBracketsInner.from_dict(_item) for _item in obj["price_brackets"]] if obj.get("price_brackets") is not None else None,
