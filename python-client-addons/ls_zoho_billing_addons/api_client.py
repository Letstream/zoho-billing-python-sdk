...
from ls_zoho_billing_addons.configuration import Configuration
from ls_zoho_billing_addons.api_response import ApiResponse, T as ApiResponseT
import ls_zoho_billing_addons.models
from ls_zoho_billing_addons import rest
from ls_zoho_billing_addons.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ls_zoho_billing_addons.models, klass)
