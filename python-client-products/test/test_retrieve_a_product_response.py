...
class TestRetrieveAProductResponse(unittest.TestCase):
    """RetrieveAProductResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveAProductResponse:
        """Test RetrieveAProductResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveAProductResponse`
        """
        model = RetrieveAProductResponse()
        if include_optional:
            return RetrieveAProductResponse(
                code = 0,
                message = 'success',
    ...
    def testRetrieveAProductResponse(self):
        """Test RetrieveAProductResponse"""
