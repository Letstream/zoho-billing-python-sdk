...
class TestListOfAllProductsResponseProductsInner(unittest.TestCase):
    """ListOfAllProductsResponseProductsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfAllProductsResponseProductsInner:
        """Test ListOfAllProductsResponseProductsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfAllProductsResponseProductsInner`
        """
        model = ListOfAllProductsResponseProductsInner()
        if include_optional:
            return ListOfAllProductsResponseProductsInner(
    ...
    def testListOfAllProductsResponseProductsInner(self):
        """Test ListOfAllProductsResponseProductsInner"""
