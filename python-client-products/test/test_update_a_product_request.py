...
class TestUpdateAProductRequest(unittest.TestCase):
    """UpdateAProductRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAProductRequest:
        """Test UpdateAProductRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAProductRequest`
        """
        model = UpdateAProductRequest()
        if include_optional:
    ...
    def testUpdateAProductRequest(self):
        """Test UpdateAProductRequest"""
