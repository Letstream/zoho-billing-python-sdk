...
class TestUpdateAProductResponse(unittest.TestCase):
    """UpdateAProductResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAProductResponse:
        """Test UpdateAProductResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAProductResponse`
        """
        model = UpdateAProductResponse()
        if include_optional:
            return UpdateAProductResponse(
                code = 0,
                message = 'The product details have been updated.',
                product = ls_zoho_billing_products.models.list_of_all_products_response_products_inner.list_of_all_products_response_products_inner(
    ...
    def testUpdateAProductResponse(self):
        """Test UpdateAProductResponse"""
