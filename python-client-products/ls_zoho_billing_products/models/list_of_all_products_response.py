...
class ListOfAllProductsResponse(BaseModel):
    """
    ListOfAllProductsResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    products: Optional[List[ListOfAllProductsResponseProductsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [ListOfAllProductsResponseProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
