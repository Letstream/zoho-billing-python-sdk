...
class RetrieveAProductResponse(BaseModel):
    """
    RetrieveAProductResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    product: Optional[ListOfAllProductsResponseProductsInner] = None
    __properties: ClassVar[List[str]] = ["code", "message", "product"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product": ListOfAllProductsResponseProductsInner.from_dict(obj["product"]) if obj.get("product") is not None else None
        })
        return _obj
