...
class TestGetAnEstimateResponse(unittest.TestCase):
    """GetAnEstimateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnEstimateResponse:
        """Test GetAnEstimateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnEstimateResponse`
        """
        model = GetAnEstimateResponse()
        if include_optional:
            return GetAnEstimateResponse(
                code = 0,
                message = 'success',
                estimate = ls_zoho_billing_quotes.models.get_an_estimate_response_estimate.get_an_estimate_response_estimate(
    ...
    def testGetAnEstimateResponse(self):
        """Test GetAnEstimateResponse"""
