...
class TestListEstimateTemplatesResponseTemplates(unittest.TestCase):
    """ListEstimateTemplatesResponseTemplates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListEstimateTemplatesResponseTemplates:
        """Test ListEstimateTemplatesResponseTemplates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListEstimateTemplatesResponseTemplates`
        """
        model = ListEstimateTemplatesResponseTemplates()
        if include_optional:
            return ListEstimateTemplatesResponseTemplates(
    ...
    def testListEstimateTemplatesResponseTemplates(self):
        """Test ListEstimateTemplatesResponseTemplates"""
