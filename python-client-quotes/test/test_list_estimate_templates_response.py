...
class TestListEstimateTemplatesResponse(unittest.TestCase):
    """ListEstimateTemplatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListEstimateTemplatesResponse:
        """Test ListEstimateTemplatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListEstimateTemplatesResponse`
        """
        model = ListEstimateTemplatesResponse()
        if include_optional:
            return ListEstimateTemplatesResponse(
                code = 0,
                message = 'success',
                templates = ls_zoho_billing_quotes.models.list_estimate_templates_response_templates.list_estimate_templates_response_templates(
    ...
    def testListEstimateTemplatesResponse(self):
        """Test ListEstimateTemplatesResponse"""
