...
class TestToContactsInner(unittest.TestCase):
    """ToContactsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToContactsInner:
        """Test ToContactsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToContactsInner`
        """
        model = ToContactsInner()
        if include_optional:
            return ToContactsInner(
                first_name = 'David',
                selected = True,
                phone = '1234',
                email = '',
