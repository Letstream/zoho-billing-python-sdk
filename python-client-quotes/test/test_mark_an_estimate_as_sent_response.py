...
class TestMarkAnEstimateAsSentResponse(unittest.TestCase):
    """MarkAnEstimateAsSentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkAnEstimateAsSentResponse:
        """Test MarkAnEstimateAsSentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkAnEstimateAsSentResponse`
        """
        model = MarkAnEstimateAsSentResponse()
        if include_optional:
            return MarkAnEstimateAsSentResponse(
                code = 0,
    ...
    def testMarkAnEstimateAsSentResponse(self):
        """Test MarkAnEstimateAsSentResponse"""
