...
class TestEmailMultipleEstimatesResponse(unittest.TestCase):
    """EmailMultipleEstimatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailMultipleEstimatesResponse:
        """Test EmailMultipleEstimatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailMultipleEstimatesResponse`
        """
        model = EmailMultipleEstimatesResponse()
        if include_optional:
            return EmailMultipleEstimatesResponse(
                code = 0,
    ...
    def testEmailMultipleEstimatesResponse(self):
        """Test EmailMultipleEstimatesResponse"""
