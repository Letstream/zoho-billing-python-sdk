...
class TestMarkAnEstimateAsDeclinedResponse(unittest.TestCase):
    """MarkAnEstimateAsDeclinedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkAnEstimateAsDeclinedResponse:
        """Test MarkAnEstimateAsDeclinedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkAnEstimateAsDeclinedResponse`
        """
        model = MarkAnEstimateAsDeclinedResponse()
        if include_optional:
            return MarkAnEstimateAsDeclinedResponse(
                code = 0,
    ...
    def testMarkAnEstimateAsDeclinedResponse(self):
        """Test MarkAnEstimateAsDeclinedResponse"""
