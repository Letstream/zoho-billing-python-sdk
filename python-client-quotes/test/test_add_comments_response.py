...
class TestAddCommentsResponse(unittest.TestCase):
    """AddCommentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddCommentsResponse:
        """Test AddCommentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddCommentsResponse`
        """
        model = AddCommentsResponse()
        if include_optional:
    ...
    def testAddCommentsResponse(self):
        """Test AddCommentsResponse"""
