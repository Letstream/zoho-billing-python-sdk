...
class TestBulkExportEstimatesResponse(unittest.TestCase):
    """BulkExportEstimatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkExportEstimatesResponse:
        """Test BulkExportEstimatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkExportEstimatesResponse`
        """
        model = BulkExportEstimatesResponse()
        if include_optional:
            return BulkExportEstimatesResponse(
                code = 0,
                message = 'success'
            )
        else:
    ...
    def testBulkExportEstimatesResponse(self):
        """Test BulkExportEstimatesResponse"""
