...
class TestGetEstimateEmailContentResponseFromEmailsInner(unittest.TestCase):
    """GetEstimateEmailContentResponseFromEmailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEstimateEmailContentResponseFromEmailsInner:
        """Test GetEstimateEmailContentResponseFromEmailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEstimateEmailContentResponseFromEmailsInner`
        """
        model = GetEstimateEmailContentResponseFromEmailsInner()
        if include_optional:
            return GetEstimateEmailContentResponseFromEmailsInner(
    ...
    def testGetEstimateEmailContentResponseFromEmailsInner(self):
        """Test GetEstimateEmailContentResponseFromEmailsInner"""
