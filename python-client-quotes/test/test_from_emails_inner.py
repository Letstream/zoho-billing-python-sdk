...
class TestFromEmailsInner(unittest.TestCase):
    """FromEmailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FromEmailsInner:
        """Test FromEmailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FromEmailsInner`
        """
        model = FromEmailsInner()
        if include_optional:
            return FromEmailsInner(
