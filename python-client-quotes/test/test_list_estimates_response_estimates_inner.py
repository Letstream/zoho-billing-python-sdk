...
class TestListEstimatesResponseEstimatesInner(unittest.TestCase):
    """ListEstimatesResponseEstimatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListEstimatesResponseEstimatesInner:
        """Test ListEstimatesResponseEstimatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListEstimatesResponseEstimatesInner`
        """
        model = ListEstimatesResponseEstimatesInner()
        if include_optional:
            return ListEstimatesResponseEstimatesInner(
    ...
    def testListEstimatesResponseEstimatesInner(self):
        """Test ListEstimatesResponseEstimatesInner"""
