...
class TestUpdateAnEstimateResponseEstimate(unittest.TestCase):
    """UpdateAnEstimateResponseEstimate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnEstimateResponseEstimate:
        """Test UpdateAnEstimateResponseEstimate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnEstimateResponseEstimate`
        """
        model = UpdateAnEstimateResponseEstimate()
        if include_optional:
            return UpdateAnEstimateResponseEstimate(
    ...
    def testUpdateAnEstimateResponseEstimate(self):
        """Test UpdateAnEstimateResponseEstimate"""
