...
class TestBulkPrintEstimatesResponse(unittest.TestCase):
    """BulkPrintEstimatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkPrintEstimatesResponse:
        """Test BulkPrintEstimatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPrintEstimatesResponse`
        """
        model = BulkPrintEstimatesResponse()
        if include_optional:
            return BulkPrintEstimatesResponse(
                code = 0,
                message = 'success'
            )
        else:
    ...
    def testBulkPrintEstimatesResponse(self):
        """Test BulkPrintEstimatesResponse"""
