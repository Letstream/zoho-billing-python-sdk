...
class TestUpdateEstimateTemplateResponse(unittest.TestCase):
    """UpdateEstimateTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEstimateTemplateResponse:
        """Test UpdateEstimateTemplateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateEstimateTemplateResponse`
        """
        model = UpdateEstimateTemplateResponse()
        if include_optional:
            return UpdateEstimateTemplateResponse(
                code = 0,
    ...
    def testUpdateEstimateTemplateResponse(self):
        """Test UpdateEstimateTemplateResponse"""
