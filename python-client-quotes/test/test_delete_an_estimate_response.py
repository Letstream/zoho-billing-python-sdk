...
class TestDeleteAnEstimateResponse(unittest.TestCase):
    """DeleteAnEstimateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteAnEstimateResponse:
        """Test DeleteAnEstimateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteAnEstimateResponse`
        """
        model = DeleteAnEstimateResponse()
        if include_optional:
            return DeleteAnEstimateResponse(
                code = 0,
    ...
    def testDeleteAnEstimateResponse(self):
        """Test DeleteAnEstimateResponse"""
