...
class TestCreateAnEstimateRequest(unittest.TestCase):
    """CreateAnEstimateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnEstimateRequest:
        """Test CreateAnEstimateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnEstimateRequest`
        """
        model = CreateAnEstimateRequest()
        if include_optional:
            return CreateAnEstimateRequest(
                ...
                line_items = [
                    ls_zoho_billing_quotes.models.create_an_estimate_request_line_items_inner.create_an_estimate_request_line_items_inner(
                        item_id = ' ', 
                        name = 'Hard Drive', 
    ...
    def testCreateAnEstimateRequest(self):
        """Test CreateAnEstimateRequest"""
