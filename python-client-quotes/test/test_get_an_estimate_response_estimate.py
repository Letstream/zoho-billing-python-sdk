...
class TestGetAnEstimateResponseEstimate(unittest.TestCase):
    """GetAnEstimateResponseEstimate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnEstimateResponseEstimate:
        """Test GetAnEstimateResponseEstimate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnEstimateResponseEstimate`
        """
        model = GetAnEstimateResponseEstimate()
        if include_optional:
            return GetAnEstimateResponseEstimate(
    ...
    def testGetAnEstimateResponseEstimate(self):
        """Test GetAnEstimateResponseEstimate"""
