...
class TestUpdateCommentResponseComment(unittest.TestCase):
    """UpdateCommentResponseComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCommentResponseComment:
        """Test UpdateCommentResponseComment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCommentResponseComment`
        """
        model = UpdateCommentResponseComment()
        if include_optional:
            return UpdateCommentResponseComment(
    ...
    def testUpdateCommentResponseComment(self):
        """Test UpdateCommentResponseComment"""
