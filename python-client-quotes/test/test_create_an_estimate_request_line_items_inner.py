...
class TestCreateAnEstimateRequestLineItemsInner(unittest.TestCase):
    """CreateAnEstimateRequestLineItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnEstimateRequestLineItemsInner:
        """Test CreateAnEstimateRequestLineItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnEstimateRequestLineItemsInner`
        """
        model = CreateAnEstimateRequestLineItemsInner()
        if include_optional:
            return CreateAnEstimateRequestLineItemsInner(
                item_id = ' ',
                name = 'Hard Drive',
    ...
    def testCreateAnEstimateRequestLineItemsInner(self):
        """Test CreateAnEstimateRequestLineItemsInner"""
