...
class TestEmailAnEstimateResponse(unittest.TestCase):
    """EmailAnEstimateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailAnEstimateResponse:
        """Test EmailAnEstimateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailAnEstimateResponse`
        """
        model = EmailAnEstimateResponse()
        if include_optional:
            return EmailAnEstimateResponse(
                code = 0,
    ...
    def testEmailAnEstimateResponse(self):
        """Test EmailAnEstimateResponse"""
