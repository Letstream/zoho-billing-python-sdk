...
class TestEmailtemplatesInner(unittest.TestCase):
    """EmailtemplatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailtemplatesInner:
        """Test EmailtemplatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailtemplatesInner`
        """
        model = EmailtemplatesInner()
        if include_optional:
            return EmailtemplatesInner(
                selected = True,
                name = 'Hard Drive',
    ...
    def testEmailtemplatesInner(self):
        """Test EmailtemplatesInner"""
