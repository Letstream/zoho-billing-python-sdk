...
class TestCreateAnEstimateRequestCustomFieldsInner(unittest.TestCase):
    """CreateAnEstimateRequestCustomFieldsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnEstimateRequestCustomFieldsInner:
        """Test CreateAnEstimateRequestCustomFieldsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnEstimateRequestCustomFieldsInner`
        """
        model = CreateAnEstimateRequestCustomFieldsInner()
        if include_optional:
            return CreateAnEstimateRequestCustomFieldsInner(
                label = 'Delivery Date',
                value = '15 Dec 2013'
            )
        else:
    ...
    def testCreateAnEstimateRequestCustomFieldsInner(self):
        """Test CreateAnEstimateRequestCustomFieldsInner"""
