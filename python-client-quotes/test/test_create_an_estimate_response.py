...
class TestCreateAnEstimateResponse(unittest.TestCase):
    """CreateAnEstimateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnEstimateResponse:
        """Test CreateAnEstimateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnEstimateResponse`
        """
        model = CreateAnEstimateResponse()
        if include_optional:
            return CreateAnEstimateResponse(
                code = 0,
                message = 'The quote has been created',
                estimate = ls_zoho_billing_quotes.models.estimate_response.estimate-response(
    ...
    def testCreateAnEstimateResponse(self):
        """Test CreateAnEstimateResponse"""
