...
class TestPageContextInner(unittest.TestCase):
    """PageContextInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageContextInner:
        """Test PageContextInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageContextInner`
        """
        model = PageContextInner()
        if include_optional:
            return PageContextInner(
                page = 1,
                per_page = 200,
                has_more_page = False,
