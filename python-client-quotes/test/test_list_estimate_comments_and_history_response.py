...
class TestListEstimateCommentsAndHistoryResponse(unittest.TestCase):
    """ListEstimateCommentsAndHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListEstimateCommentsAndHistoryResponse:
        """Test ListEstimateCommentsAndHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListEstimateCommentsAndHistoryResponse`
        """
        model = ListEstimateCommentsAndHistoryResponse()
        if include_optional:
            return ListEstimateCommentsAndHistoryResponse(
                code = 0,
                message = 'success',
                comments = [
                    ls_zoho_billing_quotes.models.list_estimate_comments_and_history_response_comments_inner.list_estimate_comments_and_history_response_comments_inner(
    ...
    def testListEstimateCommentsAndHistoryResponse(self):
        """Test ListEstimateCommentsAndHistoryResponse"""
