...
class TestAddCommentsRequest(unittest.TestCase):
    """AddCommentsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddCommentsRequest:
        """Test AddCommentsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddCommentsRequest`
        """
        model = AddCommentsRequest()
        if include_optional:
            return AddCommentsRequest(
    ...
    def testAddCommentsRequest(self):
        """Test AddCommentsRequest"""
