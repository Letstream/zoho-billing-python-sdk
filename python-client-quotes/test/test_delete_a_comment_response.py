...
class TestDeleteACommentResponse(unittest.TestCase):
    """DeleteACommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteACommentResponse:
        """Test DeleteACommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteACommentResponse`
        """
        model = DeleteACommentResponse()
        if include_optional:
            return DeleteACommentResponse(
                code = 0,
    ...
    def testDeleteACommentResponse(self):
        """Test DeleteACommentResponse"""
