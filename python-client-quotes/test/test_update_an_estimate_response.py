...
class TestUpdateAnEstimateResponse(unittest.TestCase):
    """UpdateAnEstimateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnEstimateResponse:
        """Test UpdateAnEstimateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnEstimateResponse`
        """
        model = UpdateAnEstimateResponse()
        if include_optional:
            return UpdateAnEstimateResponse(
                code = 0,
                message = 'Estimate information has been updated.',
                estimate = ls_zoho_billing_quotes.models.update_an_estimate_response_estimate.update_an_estimate_response_estimate(
    ...
    def testUpdateAnEstimateResponse(self):
        """Test UpdateAnEstimateResponse"""
