...
class TestUpdateCommentRequest(unittest.TestCase):
    """UpdateCommentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCommentRequest:
        """Test UpdateCommentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCommentRequest`
        """
    ...
    def testUpdateCommentRequest(self):
        """Test UpdateCommentRequest"""
