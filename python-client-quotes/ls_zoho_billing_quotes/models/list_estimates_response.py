...
class ListEstimatesResponse(BaseModel):
    """
    ListEstimatesResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    estimates: Optional[List[ListEstimatesResponseEstimatesInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "estimates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in estimates (list)
        _items = []
        if self.estimates:
            for _item_estimates in self.estimates:
                if _item_estimates:
                    _items.append(_item_estimates.to_dict())
            _dict['estimates'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimates": [ListEstimatesResponseEstimatesInner.from_dict(_item) for _item in obj["estimates"]] if obj.get("estimates") is not None else None
        })
        return _obj
