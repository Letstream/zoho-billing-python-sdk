...
class GetEstimateEmailContentResponseFromEmailsInner(BaseModel):
    """
    GetEstimateEmailContentResponseFromEmailsInner
    """ # noqa: E501
    user_name: Optional[StrictStr] = Field(default=None, description="Name of the user")
    selected: Optional[StrictBool] = Field(default=None, description="Selected email recepients")
