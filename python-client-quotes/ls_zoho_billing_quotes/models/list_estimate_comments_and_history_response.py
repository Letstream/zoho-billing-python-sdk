...
class ListEstimateCommentsAndHistoryResponse(BaseModel):
    """
    ListEstimateCommentsAndHistoryResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    comments: Optional[List[ListEstimateCommentsAndHistoryResponseCommentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comments": [ListEstimateCommentsAndHistoryResponseCommentsInner.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None
        })
        return _obj
