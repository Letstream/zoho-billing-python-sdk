...
class PageContextInner(BaseModel):
    """
    PageContextInner
    """ # noqa: E501
    page: Optional[StrictInt] = Field(default=None, description="Number of pages")
    per_page: Optional[StrictInt] = Field(default=None, description="Per page values")
    has_more_page: Optional[StrictBool] = Field(default=None, description="Check if has more pages")
    report_name: Optional[StrictStr] = Field(default=None, description="The report name")
    applied_filter: Optional[StrictStr] = Field(default=None, description="The filer applied for sorting")
    sort_column: Optional[StrictStr] = Field(default=None, description="Sort quotes. Allowed Values <code>customer_name</code>, <code>estimate_number</code>, <code>date</code>, <code>total</code> and <code>created_time</code>")
    sort_order: Optional[StrictStr] = Field(default=None, description="The order for sorting")
    __properties: ClassVar[List[str]] = ["page", "per_page", "has_more_page", "report_name", "applied_filter", "sort_column", "sort_order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "has_more_page": obj.get("has_more_page"),
            "report_name": obj.get("report_name"),
            "applied_filter": obj.get("applied_filter"),
