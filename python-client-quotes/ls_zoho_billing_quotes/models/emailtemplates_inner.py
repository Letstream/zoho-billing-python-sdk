...
class EmailtemplatesInner(BaseModel):
    """
    EmailtemplatesInner
    """ # noqa: E501
    ...
    email_template_id: Optional[StrictStr] = Field(default=None, description="Get the email content based on a specific email template. If this param is not inputted, then the content will be based on the email template associated with the customer. If no template is associated with the customer, then default template will be used.")
    __properties: ClassVar[List[str]] = ["selected", "name", "email_template_id"]
