...
class UpdateAnEstimateResponse(BaseModel):
    """
    UpdateAnEstimateResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    estimate: Optional[UpdateAnEstimateResponseEstimate] = None
    __properties: ClassVar[List[str]] = ["code", "message", "estimate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimate": UpdateAnEstimateResponseEstimate.from_dict(obj["estimate"]) if obj.get("estimate") is not None else None
        })
        return _obj
