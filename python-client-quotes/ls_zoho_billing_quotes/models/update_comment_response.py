...
class UpdateCommentResponse(BaseModel):
    ...
    comment: Optional[UpdateCommentResponseComment] = None
    __properties: ClassVar[List[str]] = ["code", "message", "comment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": UpdateCommentResponseComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None
        })
        return _obj
