...
class EmailAnEstimateRequest(BaseModel):
    """
    ...
    to_mail_ids: List[StrictStr] = Field(description="Array of email addresses of the recipients.")
    cc_mail_ids: Optional[List[StrictStr]] = Field(default=None, description="Array of email addresses of the recipients to be CC'd.")
    ...
    __properties: ClassVar[List[str]] = ["send_from_org_email_id", "to_mail_ids", "cc_mail_ids", "subject", "body"]
