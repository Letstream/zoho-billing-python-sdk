...
class FromEmailsInner(BaseModel):
    """
    FromEmailsInner
    """ # noqa: E501
    user_name: Optional[StrictStr] = Field(default=None, description="Name of the sender of email")
    ...
    __properties: ClassVar[List[str]] = ["user_name", "selected", "email"]
