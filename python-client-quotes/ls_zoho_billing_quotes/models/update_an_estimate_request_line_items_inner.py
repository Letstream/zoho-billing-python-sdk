...
class UpdateAnEstimateRequestLineItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["item_id", "name", "description", "item_order", "rate", "quantity", "product_type", "hsn_or_sac", "sat_item_key_code", "unitkey_code", "unit", "discount_amount", "discount", "tax_id", "tds_tax_id", "tax_exemption_id", "avatax_tax_code", "avatax_use_code", "tax_name", "tax_type", "tax_percentage", "item_total"]
