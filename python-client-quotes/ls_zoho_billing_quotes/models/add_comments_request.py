...
class AddCommentsRequest(BaseModel):
    ...
    AddCommentsRequest
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="A short note on the quote")
    show_comment_to_clients: Optional[StrictBool] = Field(default=None, description="Boolean to show the comments to contacts in portal.")
    __properties: ClassVar[List[str]] = ["description", "show_comment_to_clients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "show_comment_to_clients": obj.get("show_comment_to_clients")
        })
        return _obj
