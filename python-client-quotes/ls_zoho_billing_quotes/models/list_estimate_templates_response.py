...
class ListEstimateTemplatesResponse(BaseModel):
    """
    ListEstimateTemplatesResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    templates: Optional[ListEstimateTemplatesResponseTemplates] = None
    __properties: ClassVar[List[str]] = ["code", "message", "templates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "templates": ListEstimateTemplatesResponseTemplates.from_dict(obj["templates"]) if obj.get("templates") is not None else None
        })
        return _obj
