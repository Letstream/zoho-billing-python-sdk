...
class ToContactsInner(BaseModel):
    """
    ToContactsInner
    """ # noqa: E501
    first_name: Optional[StrictStr] = Field(default=None, description="First name of the contact person")
    selected: Optional[StrictBool] = Field(default=None, description="Boolean check for the email template. Whether selected or not")
    phone: Optional[StrictStr] = Field(default=None, description="phone number of the contact person")
    email: Optional[StrictStr] = Field(default=None, description="Email ID of the contact")
    last_name: Optional[StrictStr] = Field(default=None, description="Last name of the contact person")
    salutation: Optional[StrictStr] = Field(default=None, description="Salutation for the contact")
    contact_person_id: Optional[StrictStr] = Field(default=None, description="The ID of the contact person")
