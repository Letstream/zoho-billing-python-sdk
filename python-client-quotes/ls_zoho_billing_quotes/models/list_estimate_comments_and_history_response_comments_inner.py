...
class ListEstimateCommentsAndHistoryResponseCommentsInner(BaseModel):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description="A short note on the estimate comments")
    ...
    operation_type: Optional[StrictStr] = Field(default=None, description="Type of operation on quote")
    transaction_id: Optional[StrictStr] = Field(default=None, description="ID of the transaction")
    transaction_type: Optional[StrictStr] = Field(default=None, description="Type of the transaction performed")
    __properties: ClassVar[List[str]] = ["comment_id", "estimate_id", "description", "commented_by_id", "commented_by", "comment_type", "date", "date_description", "time", "operation_type", "transaction_id", "transaction_type"]
