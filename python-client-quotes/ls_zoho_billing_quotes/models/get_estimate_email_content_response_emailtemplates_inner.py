...
class GetEstimateEmailContentResponseEmailtemplatesInner(BaseModel):
    """
    GetEstimateEmailContentResponseEmailtemplatesInner
    """ # noqa: E501
    selected: Optional[StrictBool] = Field(default=None, description="Selected email context")
    name: Optional[StrictStr] = Field(default=None, description="Name of the email receiver")
