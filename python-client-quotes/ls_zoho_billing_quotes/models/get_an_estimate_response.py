...
class GetAnEstimateResponse(BaseModel):
    """
    GetAnEstimateResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    estimate: Optional[GetAnEstimateResponseEstimate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimate": GetAnEstimateResponseEstimate.from_dict(obj["estimate"]) if obj.get("estimate") is not None else None
        })
        return _obj
