...
class UpdateAnEstimateRequest(BaseModel):
    """
    ...
    custom_fields: List[CreateAnEstimateRequestCustomFieldsInner] = Field(description="Custom fields for an estimate.")
    line_items: Optional[List[UpdateAnEstimateRequestLineItemsInner]] = Field(default=None, description="Line items of a quote.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "line_items": [UpdateAnEstimateRequestLineItemsInner.from_dict(_item) for _item in obj["line_items"]] if obj.get("line_items") is not None else None,
            "notes": obj.get("notes"),
            "terms": obj.get("terms"),
