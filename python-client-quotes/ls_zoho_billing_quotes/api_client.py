...
from ls_zoho_billing_quotes.configuration import Configuration
from ls_zoho_billing_quotes.api_response import ApiResponse, T as ApiResponseT
import ls_zoho_billing_quotes.models
from ls_zoho_billing_quotes import rest
from ls_zoho_billing_quotes.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ls_zoho_billing_quotes.models, klass)
