...
class RetrieveListOfTaxesResponse(BaseModel):
    """
    RetrieveListOfTaxesResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    taxes: Optional[List[TaxesResponse]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "taxes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxes": [TaxesResponse.from_dict(_item) for _item in obj["taxes"]] if obj.get("taxes") is not None else None
        })
        return _obj
