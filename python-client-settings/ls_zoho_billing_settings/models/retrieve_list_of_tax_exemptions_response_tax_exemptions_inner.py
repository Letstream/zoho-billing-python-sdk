...
class RetrieveListOfTaxExemptionsResponseTaxExemptionsInner(BaseModel):
    """
    RetrieveListOfTaxExemptionsResponseTaxExemptionsInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Appropriate description for teh tax exemption.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Tax exemption can be of customer or item type.")
    __properties: ClassVar[List[str]] = ["description", "tax_exemption_id", "tax_exemption_code", "type"]
