...
NAME = "ls_zoho_billing_unbilled_charges"
VERSION = "1.0.0"
PYTHON_REQUIRES = ">= 3.9"
REQUIRES = [
    "urllib3 >= 2.1.0, < 3.0.0",
...
setup(
    ...
    These are charges to be converted into an invoice at a later point of time, either by manual intervention or during renewal.
    """,  # noqa: E501
    package_data={"ls_zoho_billing_unbilled_charges": ["py.typed"]},
)