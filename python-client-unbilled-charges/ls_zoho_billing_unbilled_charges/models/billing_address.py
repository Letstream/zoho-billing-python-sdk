...
class BillingAddress(BaseModel):
    ...
    """ # noqa: E501
    street: Optional[StrictStr] = Field(default=None, description="Name of the street.")
    city: Optional[StrictStr] = Field(default=None, description="Name of the city.")
    state: Optional[StrictStr] = Field(default=None, description="Name of the state.")
    zip: Optional[StrictStr] = Field(default=None, description="Zip code of the customer's address.")
    country: Optional[StrictStr] = Field(default=None, description="Name of the country.")
