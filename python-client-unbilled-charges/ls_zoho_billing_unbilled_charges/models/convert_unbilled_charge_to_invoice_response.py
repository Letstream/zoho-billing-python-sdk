...
class ConvertUnbilledChargeToInvoiceResponse(BaseModel):
    """
    ConvertUnbilledChargeToInvoiceResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    invoice: Optional[ConvertUnbilledChargeToInvoiceResponseInvoice] = None
    __properties: ClassVar[List[str]] = ["code", "message", "invoice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice": ConvertUnbilledChargeToInvoiceResponseInvoice.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
