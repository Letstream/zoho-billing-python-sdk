...
class TestConvertUnbilledChargeToInvoiceResponseInvoice(unittest.TestCase):
    """ConvertUnbilledChargeToInvoiceResponseInvoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConvertUnbilledChargeToInvoiceResponseInvoice:
        """Test ConvertUnbilledChargeToInvoiceResponseInvoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConvertUnbilledChargeToInvoiceResponseInvoice`
        """
        model = ConvertUnbilledChargeToInvoiceResponseInvoice()
        if include_optional:
            return ConvertUnbilledChargeToInvoiceResponseInvoice(
    ...
    def testConvertUnbilledChargeToInvoiceResponseInvoice(self):
        """Test ConvertUnbilledChargeToInvoiceResponseInvoice"""
