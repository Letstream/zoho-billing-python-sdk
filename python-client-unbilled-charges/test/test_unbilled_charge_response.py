...
class TestUnbilledChargeResponse(unittest.TestCase):
    """UnbilledChargeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnbilledChargeResponse:
        """Test UnbilledChargeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnbilledChargeResponse`
        """
        model = UnbilledChargeResponse()
        if include_optional:
            return UnbilledChargeResponse(
    ...
    def testUnbilledChargeResponse(self):
        """Test UnbilledChargeResponse"""
