...
class TestUpdateAnExpenseResponseExpense(unittest.TestCase):
    """UpdateAnExpenseResponseExpense unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnExpenseResponseExpense:
        """Test UpdateAnExpenseResponseExpense
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnExpenseResponseExpense`
        """
        model = UpdateAnExpenseResponseExpense()
        if include_optional:
            return UpdateAnExpenseResponseExpense(
    ...
    def testUpdateAnExpenseResponseExpense(self):
        """Test UpdateAnExpenseResponseExpense"""
