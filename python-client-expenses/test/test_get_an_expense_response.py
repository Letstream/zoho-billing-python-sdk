...
class TestGetAnExpenseResponse(unittest.TestCase):
    """GetAnExpenseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnExpenseResponse:
        """Test GetAnExpenseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnExpenseResponse`
        """
        model = GetAnExpenseResponse()
        if include_optional:
            return GetAnExpenseResponse(
                code = 0,
                message = 'success',
                expense = ls_zoho_billing_expenses.models.get_an_expense_response_expense.get_an_expense_response_expense(
                    ...
                    line_item = ls_zoho_billing_expenses.models.get_an_expense_response_expense_line_item.get_an_expense_response_expense_line_item(
    ...
    def testGetAnExpenseResponse(self):
        """Test GetAnExpenseResponse"""
