...
class TestGetAnExpenseResponseExpense(unittest.TestCase):
    """GetAnExpenseResponseExpense unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnExpenseResponseExpense:
        """Test GetAnExpenseResponseExpense
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnExpenseResponseExpense`
        """
        model = GetAnExpenseResponseExpense()
        if include_optional:
            return GetAnExpenseResponseExpense(
    ...
    def testGetAnExpenseResponseExpense(self):
        """Test GetAnExpenseResponseExpense"""
