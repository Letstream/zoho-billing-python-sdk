...
class TestUpdateAnExpenseResponse(unittest.TestCase):
    """UpdateAnExpenseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnExpenseResponse:
        """Test UpdateAnExpenseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnExpenseResponse`
        """
        model = UpdateAnExpenseResponse()
        if include_optional:
            return UpdateAnExpenseResponse(
                code = 0,
                message = 'Expense information has been updated.',
                expense = ls_zoho_billing_expenses.models.update_an_expense_response_expense.update_an_expense_response_expense(
    ...
    def testUpdateAnExpenseResponse(self):
        """Test UpdateAnExpenseResponse"""
