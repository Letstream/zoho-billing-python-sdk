...
class TestListExpensesResponse(unittest.TestCase):
    """ListExpensesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListExpensesResponse:
        """Test ListExpensesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListExpensesResponse`
        """
        model = ListExpensesResponse()
        if include_optional:
            return ListExpensesResponse(
                code = 0,
                message = 'success',
                expenses = [
                    ls_zoho_billing_expenses.models.list_expenses_response_expenses_inner.list_expenses_response_expenses_inner(
    ...
    def testListExpensesResponse(self):
        """Test ListExpensesResponse"""
