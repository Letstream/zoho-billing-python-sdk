...
class TestDeleteAnExpenseResponse(unittest.TestCase):
    """DeleteAnExpenseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteAnExpenseResponse:
        """Test DeleteAnExpenseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteAnExpenseResponse`
        """
        model = DeleteAnExpenseResponse()
        if include_optional:
            return DeleteAnExpenseResponse(
                code = 0,
    ...
    def testDeleteAnExpenseResponse(self):
        """Test DeleteAnExpenseResponse"""
