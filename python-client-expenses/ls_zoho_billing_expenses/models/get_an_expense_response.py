...
class GetAnExpenseResponse(BaseModel):
    """
    GetAnExpenseResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    expense: Optional[GetAnExpenseResponseExpense] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expense": GetAnExpenseResponseExpense.from_dict(obj["expense"]) if obj.get("expense") is not None else None
        })
        return _obj
