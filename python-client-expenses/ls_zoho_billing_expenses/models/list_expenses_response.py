...
class ListExpensesResponse(BaseModel):
    ...
    expenses: Optional[List[ListExpensesResponseExpensesInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "expenses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expenses": [ListExpensesResponseExpensesInner.from_dict(_item) for _item in obj["expenses"]] if obj.get("expenses") is not None else None
        })
        return _obj
