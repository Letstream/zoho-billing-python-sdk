...
class GetAnExpenseResponseExpense(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "line_item": GetAnExpenseResponseExpenseLineItem.from_dict(obj["line_item"]) if obj.get("line_item") is not None else None
        })
        return _obj
