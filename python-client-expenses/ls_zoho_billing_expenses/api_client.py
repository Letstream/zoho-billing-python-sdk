...
from ls_zoho_billing_expenses.configuration import Configuration
from ls_zoho_billing_expenses.api_response import ApiResponse, T as ApiResponseT
import ls_zoho_billing_expenses.models
from ls_zoho_billing_expenses import rest
from ls_zoho_billing_expenses.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ls_zoho_billing_expenses.models, klass)
