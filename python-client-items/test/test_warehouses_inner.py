...
class TestWarehousesInner(unittest.TestCase):
    """WarehousesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WarehousesInner:
        """Test WarehousesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WarehousesInner`
        """
        model = WarehousesInner()
        if include_optional:
            return WarehousesInner(
                warehouse_id = '',
                warehouse_name = '',
                status = 'active',
                is_primary = False,
