...
class TestUpdateAnItemResponse(unittest.TestCase):
    """UpdateAnItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnItemResponse:
        """Test UpdateAnItemResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnItemResponse`
        """
        model = UpdateAnItemResponse()
        if include_optional:
            return UpdateAnItemResponse(
                code = 0,
    ...
    def testUpdateAnItemResponse(self):
        """Test UpdateAnItemResponse"""
