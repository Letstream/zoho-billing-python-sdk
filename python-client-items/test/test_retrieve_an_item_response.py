...
class TestRetrieveAnItemResponse(unittest.TestCase):
    """RetrieveAnItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveAnItemResponse:
        """Test RetrieveAnItemResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveAnItemResponse`
        """
        model = RetrieveAnItemResponse()
        if include_optional:
            return RetrieveAnItemResponse(
                code = 0,
                message = 'success',
                item = ls_zoho_billing_items.models.update_an_item_response_item.update_an_item_response_item(
    ...
    def testRetrieveAnItemResponse(self):
        """Test RetrieveAnItemResponse"""
