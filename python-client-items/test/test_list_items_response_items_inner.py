...
class TestListItemsResponseItemsInner(unittest.TestCase):
    """ListItemsResponseItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListItemsResponseItemsInner:
        """Test ListItemsResponseItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListItemsResponseItemsInner`
        """
        model = ListItemsResponseItemsInner()
        if include_optional:
            return ListItemsResponseItemsInner(
    ...
    def testListItemsResponseItemsInner(self):
        """Test ListItemsResponseItemsInner"""
