...
class TestUpdateAnItemResponseItem(unittest.TestCase):
    """UpdateAnItemResponseItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnItemResponseItem:
        """Test UpdateAnItemResponseItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnItemResponseItem`
        """
        model = UpdateAnItemResponseItem()
        if include_optional:
            return UpdateAnItemResponseItem(
    ...
    def testUpdateAnItemResponseItem(self):
        """Test UpdateAnItemResponseItem"""
