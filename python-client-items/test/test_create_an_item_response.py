...
class TestCreateAnItemResponse(unittest.TestCase):
    """CreateAnItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnItemResponse:
        """Test CreateAnItemResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnItemResponse`
        """
        model = CreateAnItemResponse()
        if include_optional:
            return CreateAnItemResponse(
                code = 0,
                message = 'The item has been added.',
                item = ls_zoho_billing_items.models.item_response.item-response(
    ...
    def testCreateAnItemResponse(self):
        """Test CreateAnItemResponse"""
