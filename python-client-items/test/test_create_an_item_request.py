...
class TestCreateAnItemRequest(unittest.TestCase):
    """CreateAnItemRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnItemRequest:
        """Test CreateAnItemRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnItemRequest`
        """
        model = CreateAnItemRequest()
        if include_optional:
            return CreateAnItemRequest(
                name = 'Hard Drive',
                rate = 120,
                description = '500GB',
    ...
    def testCreateAnItemRequest(self):
        """Test CreateAnItemRequest"""
