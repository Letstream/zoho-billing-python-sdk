...
class ItemTaxPreferencesInner(BaseModel):
    ...
    tax_specification: Optional[StrictStr] = Field(default=None, description="Set whether the tax type is intra/interstate")
    __properties: ClassVar[List[str]] = ["tax_id", "tax_specification"]
