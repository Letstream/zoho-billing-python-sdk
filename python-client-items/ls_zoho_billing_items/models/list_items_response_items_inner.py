...
class ListItemsResponseItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["item_id", "name", "status", "description", "rate", "unit", "tax_id", "tax_name", "tax_percentage", "tax_type", "sku", "product_type", "custom_fields"]
