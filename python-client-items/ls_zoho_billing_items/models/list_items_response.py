...
class ListItemsResponse(BaseModel):
    ...
    items: Optional[List[ListItemsResponseItemsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ListItemsResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
