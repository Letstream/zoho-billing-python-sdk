...
class RetrieveAnItemResponse(BaseModel):
    """
    RetrieveAnItemResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    item: Optional[UpdateAnItemResponseItem] = None
    __properties: ClassVar[List[str]] = ["code", "message", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": UpdateAnItemResponseItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
