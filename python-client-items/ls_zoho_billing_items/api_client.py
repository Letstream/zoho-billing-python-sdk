...
from ls_zoho_billing_items.configuration import Configuration
from ls_zoho_billing_items.api_response import ApiResponse, T as ApiResponseT
import ls_zoho_billing_items.models
from ls_zoho_billing_items import rest
from ls_zoho_billing_items.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ls_zoho_billing_items.models, klass)
