...
class ApplyCreditsToMultipleInvoicesRequest(BaseModel):
    """
    ApplyCreditsToMultipleInvoicesRequest
    """ # noqa: E501
    invoices: List[ApplyCreditsToMultipleInvoicesRequestInvoicesInner] = Field(description="List of invoices for which the credit note has been raised. This contains <code>invoice_id</code> and <code>amount</code>.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [ApplyCreditsToMultipleInvoicesRequestInvoicesInner.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
