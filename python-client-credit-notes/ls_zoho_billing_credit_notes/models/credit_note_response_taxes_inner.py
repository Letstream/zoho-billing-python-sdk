...
class CreditNoteResponseTaxesInner(BaseModel):
    """
    ...
    tax_name: Optional[StrictStr] = Field(default=None, description="Unique name for tax.")
    tax_amount: Optional[StrictStr] = Field(default=None, description="Tax amount applied to the subscription.")
    __properties: ClassVar[List[str]] = ["tax_id", "tax_name", "tax_amount"]
