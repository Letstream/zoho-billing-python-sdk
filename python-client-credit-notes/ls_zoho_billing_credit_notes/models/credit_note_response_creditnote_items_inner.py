...
class CreditNoteResponseCreditnoteItemsInner(BaseModel):
    """
    CreditNoteResponseCreditnoteItemsInner
    """ # noqa: E501
    item_id: Optional[StrictStr] = Field(default=None, description="Unique string generated for the item to which a refund is to be made.")
    description: Optional[StrictStr] = Field(default=None, description="A small description about the item.")
    code: Optional[StrictStr] = Field(default=None, description="Unique code for the creditnote line item.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the credit")
    type: Optional[StrictInt] = Field(default=None, description="Type of the creditnote line item.")
    account_id: Optional[StrictStr] = Field(default=None, description="Unique ID to denote the account.")
    account_name: Optional[StrictStr] = Field(default=None, description="Name of the account.")
    quantity: Optional[StrictInt] = Field(default=None, description="Quantity of the item included.")
    ...
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price of the item included.")
    item_total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total credits raised by this item. This would be the multiplicative product of item price and quantity.")
    ...
    __properties: ClassVar[List[str]] = ["item_id", "description", "code", "tags", "item_custom_fields", "name", "type", "account_id", "account_name", "quantity", "tax_id", "tds_tax_id", "price", "item_total", "sat_item_key_code", "unitkey_code"]
