...
class CreditNoteResponseInvoicesInner(BaseModel):
    """
    ...
    invoice_number: Optional[StrictStr] = Field(default=None, description="Invoice number of the required invoice.")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount paid for the invoice.")
    __properties: ClassVar[List[str]] = ["invoice_id", "invoice_number", "amount"]
