...
class RetreiveACreditNoteResponse(BaseModel):
    """
    RetreiveACreditNoteResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    credit_note: Optional[RetreiveACreditNoteResponseCreditNote] = None
    __properties: ClassVar[List[str]] = ["code", "message", "credit_note"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credit_note": RetreiveACreditNoteResponseCreditNote.from_dict(obj["credit_note"]) if obj.get("credit_note") is not None else None
        })
        return _obj
