...
class ApplyCreditsToMultipleInvoicesResponse(BaseModel):
    """
    ApplyCreditsToMultipleInvoicesResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    invoices: Optional[List[ApplyCreditsToMultipleInvoicesResponseInvoicesInner]] = Field(default=None, description="List of invoices for which the credit note has been raised. This contains <code>invoice_id</code> and <code>amount</code>.")
    __properties: ClassVar[List[str]] = ["code", "message", "invoices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [ApplyCreditsToMultipleInvoicesResponseInvoicesInner.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
