...
from ls_zoho_billing_events.configuration import Configuration
from ls_zoho_billing_events.api_response import ApiResponse, T as ApiResponseT
import ls_zoho_billing_events.models
from ls_zoho_billing_events import rest
from ls_zoho_billing_events.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ls_zoho_billing_events.models, klass)
