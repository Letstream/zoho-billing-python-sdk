...
class ListOfEventsResponse(BaseModel):
    """
    ListOfEventsResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    events: Optional[List[ListOfEventsResponseEventsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [ListOfEventsResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
