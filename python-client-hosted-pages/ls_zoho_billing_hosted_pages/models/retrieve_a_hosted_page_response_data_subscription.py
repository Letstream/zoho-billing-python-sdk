...
class RetrieveAHostedPageResponseDataSubscription(BaseModel):
    """
    ...
    pricebook_id: Optional[StrictStr] = Field(default=None, description="Unique ID of of pricebook.")
    ...
    plan: Optional[RetrieveAHostedPageResponseDataSubscriptionPlan] = None
    addons: Optional[List[RetrieveAHostedPageResponseDataSubscriptionAddonsInner]] = Field(default=None, description="List of addon objects which are to be included in the subscription. Each object contains <code>addon_code</code>, <code>name</code>, <code>price</code> and <code>quantity</code>.")
    taxes: Optional[List[StrictStr]] = Field(default=None, description="Details of the taxes associated with the subscription.")
    coupon: Optional[DataSubscriptionCoupon] = None
    card: Optional[DataSubscriptionCard] = None
    ...
    customer: Optional[RetrieveAHostedPageResponseDataSubscriptionCustomer] = None
    ...
    contactpersons: Optional[List[DataSubscriptionContactpersonsInner]] = Field(default=None, description="List of contact person objects. Each object contains <code>contactperson_id</code> and <code>email</code>.")
    notes: Optional[List[DataSubscriptionNotesInner]] = Field(default=None, description="List of objects containing <code>note_id</code>, <code>description</code>, <code>commented_by</code> and <code>commented_time</code>")
    ...
    __properties: ClassVar[List[str]] = ["subscription_id", "name", "status", "amount", "created_at", "current_term_starts_at", "current_term_ends_at", "next_billing_at", "expires_at", "interval", "interval_unit", "created_time", "updated_time", "reference_id", "salesperson_id", "salesperson_name", "child_invoice_id", "pricebook_id", "currency_code", "currency_symbol", "end_of_term", "product_id", "product_name", "plan", "addons", "taxes", "coupon", "card", "payment_terms", "payment_terms_label", "can_add_bank_account", "customer", "custom_fields", "contactpersons", "notes", "payment_gateways"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plan": RetrieveAHostedPageResponseDataSubscriptionPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None,
            "addons": [RetrieveAHostedPageResponseDataSubscriptionAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None,
            "taxes": obj.get("taxes"),
            "coupon": DataSubscriptionCoupon.from_dict(obj["coupon"]) if obj.get("coupon") is not None else None,
            "card": DataSubscriptionCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
            ...
            "customer": RetrieveAHostedPageResponseDataSubscriptionCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            ...
            "contactpersons": [DataSubscriptionContactpersonsInner.from_dict(_item) for _item in obj["contactpersons"]] if obj.get("contactpersons") is not None else None,
            "notes": [DataSubscriptionNotesInner.from_dict(_item) for _item in obj["notes"]] if obj.get("notes") is not None else None,
