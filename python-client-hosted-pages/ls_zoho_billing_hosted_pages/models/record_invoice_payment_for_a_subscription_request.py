...
class RecordInvoicePaymentForASubscriptionRequest(BaseModel):
    """
    RecordInvoicePaymentForASubscriptionRequest
    """ # noqa: E501
    invoice_id: StrictStr = Field(description="Unique ID generated for an invoice.")
    ...
    hostedpage_settings_id: Optional[StrictStr] = Field(default=None, description="Hostedpage Template ID for the Subscriptions")
    ...
    __properties: ClassVar[List[str]] = ["invoice_id", "redirect_url", "hostedpage_settings_id", "payment_gateways"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostedpage_settings_id": obj.get("hostedpage_settings_id"),
