...
class DataSubscriptionPlan(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "name", "quantity", "price", "discount", "total", "setup_fee", "description", "tax_id", "exclude_trial", "exclude_setup_fee", "trial_days"]
