...
class RetrieveAHostedPageResponseDataSubscriptionCustomer(BaseModel):
    """
    ...
    """ # noqa: E501
    customer_id: Optional[Any] = Field(default=None, description="A unique ID generated by the server. This can be used as an identifier.")
    ...
    billing_address: Optional[DataSubscriptionCustomerBillingAddress] = None
    ...
    tax_authority_name: Optional[StrictStr] = Field(default=None, description="Unique name of the tax authority.")
    ...
    __properties: ClassVar[List[str]] = ["customer_id", "display_name", "first_name", "last_name", "email", "company_name", "billing_address", "shipping_address", "is_taxable", "tax_authority_name", "tax_exemption_id", "payment_terms", "payment_terms_label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billing_address": DataSubscriptionCustomerBillingAddress.from_dict(obj["billing_address"]) if obj.get("billing_address") is not None else None,
