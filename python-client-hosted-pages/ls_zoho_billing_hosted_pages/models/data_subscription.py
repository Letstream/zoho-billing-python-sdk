...
class DataSubscription(BaseModel):
    ...
    plan: Optional[DataSubscriptionPlan] = None
    addons: Optional[List[DataSubscriptionAddonsInner]] = Field(default=None, description="List of addon objects which are to be included in the subscription. Each object contains <code>addon_code</code>, <code>name</code>, <code>price</code> and <code>quantity</code>.")
    taxes: Optional[List[DataSubscriptionTaxesInner]] = Field(default=None, description="Taxes associated wit the subscription.")
    ...
    customer: Optional[DataSubscriptionCustomer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plan": DataSubscriptionPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None,
            "addons": [DataSubscriptionAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None,
            "taxes": [DataSubscriptionTaxesInner.from_dict(_item) for _item in obj["taxes"]] if obj.get("taxes") is not None else None,
            ...
            "customer": DataSubscriptionCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
