...
class UpdatePaymentMethodResponse(BaseModel):
    ...
    hostedpage: Optional[UpdatePaymentMethodResponseHostedpage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostedpage": UpdatePaymentMethodResponseHostedpage.from_dict(obj["hostedpage"]) if obj.get("hostedpage") is not None else None
        })
        return _obj
