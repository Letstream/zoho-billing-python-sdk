...
class Plan(BaseModel):
    ...
    sub_total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Subtotal for the subscription without including taxes.")
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "name", "quantity", "price", "tags", "discount", "sub_total", "setup_fee", "description", "tax_id", "exclude_trial", "exclude_setup_fee", "trial_days"]
