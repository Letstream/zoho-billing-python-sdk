...
class UpdateASubscriptionResponse(BaseModel):
    """
    UpdateASubscriptionResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    hostedpage: Optional[UpdateASubscriptionResponseHostedpage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostedpage": UpdateASubscriptionResponseHostedpage.from_dict(obj["hostedpage"]) if obj.get("hostedpage") is not None else None
        })
        return _obj
