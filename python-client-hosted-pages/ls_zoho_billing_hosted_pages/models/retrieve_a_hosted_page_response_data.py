...
class RetrieveAHostedPageResponseData(BaseModel):
    """
    data
    """ # noqa: E501
    subscription: Optional[RetrieveAHostedPageResponseDataSubscription] = None
    invoice: Optional[RetrieveAHostedPageResponseDataInvoice] = None
    __properties: ClassVar[List[str]] = ["subscription", "invoice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscription": RetrieveAHostedPageResponseDataSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None,
            "invoice": RetrieveAHostedPageResponseDataInvoice.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
