...
class UpdatePaymentMethodRequest(BaseModel):
    ...
    """ # noqa: E501
    card_id: StrictStr = Field(description="Card number associated to the customer.")
    account_id: StrictStr = Field(description="Bank account number associated to the customer for ACH payments.")
    paypal_id: StrictStr = Field(description="PayPal account number associated to the customer.")
    __properties: ClassVar[List[str]] = ["card_id", "account_id", "paypal_id"]
