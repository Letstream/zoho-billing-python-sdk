...
class RecordInvoicePaymentForASubscriptionResponse(BaseModel):
    """
    RecordInvoicePaymentForASubscriptionResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    hostedpage: Optional[RecordInvoicePaymentForASubscriptionResponseHostedpage] = None
    __properties: ClassVar[List[str]] = ["code", "message", "hostedpage"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of hostedpage
        if self.hostedpage:
            _dict['hostedpage'] = self.hostedpage.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostedpage": RecordInvoicePaymentForASubscriptionResponseHostedpage.from_dict(obj["hostedpage"]) if obj.get("hostedpage") is not None else None
        })
        return _obj
