...
class UpdateASubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["subscription_id", "plan", "addons", "reference_id", "starts_at", "custom_fields", "coupon_code", "salesperson_name", "can_charge_setup_fee_immediately", "gst_treatment", "gst_no", "cfdi_usage", "payment_gateways", "exchange_rate", "place_of_supply", "billing_address_id", "shipping_address_id", "branch_id", "template_id", "redirect_url"]
