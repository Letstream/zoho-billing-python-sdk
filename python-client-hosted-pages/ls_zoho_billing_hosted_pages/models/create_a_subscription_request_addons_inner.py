...
class CreateASubscriptionRequestAddonsInner(BaseModel):
    ...
    tax_id: Optional[Any] = Field(default=None, description="Unique ID of Tax or Tax Group that must be associated with the addon. <code>tax_id</code> must be empty for applying tax Exemption.")
    ...
    __properties: ClassVar[List[str]] = ["addon_code", "addon_description", "price", "quantity", "tags", "item_custom_fields", "tax_id", "tax_exemption_id", "tax_exemption_code"]
