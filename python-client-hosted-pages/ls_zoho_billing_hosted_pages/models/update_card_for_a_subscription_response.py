...
class UpdateCardForASubscriptionResponse(BaseModel):
    """
    UpdateCardForASubscriptionResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    hostedpage: Optional[UpdateCardForASubscriptionResponseHostedpage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostedpage": UpdateCardForASubscriptionResponseHostedpage.from_dict(obj["hostedpage"]) if obj.get("hostedpage") is not None else None
        })
        return _obj
