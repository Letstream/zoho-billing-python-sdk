...
class TestListOfHostedpagesResponse(unittest.TestCase):
    """ListOfHostedpagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfHostedpagesResponse:
        """Test ListOfHostedpagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfHostedpagesResponse`
        """
        model = ListOfHostedpagesResponse()
        if include_optional:
            return ListOfHostedpagesResponse(
                code = 0,
                message = 'success',
                hosted_pages = [
                    ls_zoho_billing_hosted_pages.models.list_of_hostedpages_response_hosted_pages_inner.list_of_hostedpages_response_hosted_pages_inner(
    ...
    def testListOfHostedpagesResponse(self):
        """Test ListOfHostedpagesResponse"""
