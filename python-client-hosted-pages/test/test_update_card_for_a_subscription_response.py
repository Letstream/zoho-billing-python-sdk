...
class TestUpdateCardForASubscriptionResponse(unittest.TestCase):
    """UpdateCardForASubscriptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCardForASubscriptionResponse:
        """Test UpdateCardForASubscriptionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCardForASubscriptionResponse`
        """
        model = UpdateCardForASubscriptionResponse()
        if include_optional:
            return UpdateCardForASubscriptionResponse(
                code = 0,
                message = 'Hosted page has been created successfully.',
                hostedpage = ls_zoho_billing_hosted_pages.models.update_card_for_a_subscription_response_hostedpage.update_card_for_a_subscription_response_hostedpage(
    ...
    def testUpdateCardForASubscriptionResponse(self):
        """Test UpdateCardForASubscriptionResponse"""
