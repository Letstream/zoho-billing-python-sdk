...
class TestUpdateASubscriptionResponseHostedpage(unittest.TestCase):
    """UpdateASubscriptionResponseHostedpage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateASubscriptionResponseHostedpage:
        """Test UpdateASubscriptionResponseHostedpage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateASubscriptionResponseHostedpage`
        """
        model = UpdateASubscriptionResponseHostedpage()
        if include_optional:
            return UpdateASubscriptionResponseHostedpage(
    ...
    def testUpdateASubscriptionResponseHostedpage(self):
        """Test UpdateASubscriptionResponseHostedpage"""
