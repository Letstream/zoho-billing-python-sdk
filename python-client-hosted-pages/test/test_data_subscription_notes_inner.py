...
class TestDataSubscriptionNotesInner(unittest.TestCase):
    """DataSubscriptionNotesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataSubscriptionNotesInner:
        """Test DataSubscriptionNotesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataSubscriptionNotesInner`
        """
        model = DataSubscriptionNotesInner()
        if include_optional:
            return DataSubscriptionNotesInner(
    ...
    def testDataSubscriptionNotesInner(self):
        """Test DataSubscriptionNotesInner"""
