...
class TestUpdatePaymentMethodResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdatePaymentMethodResponse:
        ...
        """
        model = UpdatePaymentMethodResponse()
        if include_optional:
            return UpdatePaymentMethodResponse(
                code = 0,
                message = 'Hosted page has been created successfully.',
                hostedpage = ls_zoho_billing_hosted_pages.models.update_payment_method_response_hostedpage.update_payment_method_response_hostedpage(
