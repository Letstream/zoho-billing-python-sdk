...
class TestUpdateCardForASubscriptionResponseHostedpage(unittest.TestCase):
    """UpdateCardForASubscriptionResponseHostedpage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCardForASubscriptionResponseHostedpage:
        """Test UpdateCardForASubscriptionResponseHostedpage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCardForASubscriptionResponseHostedpage`
        """
        model = UpdateCardForASubscriptionResponseHostedpage()
        if include_optional:
            return UpdateCardForASubscriptionResponseHostedpage(
    ...
    def testUpdateCardForASubscriptionResponseHostedpage(self):
        """Test UpdateCardForASubscriptionResponseHostedpage"""
