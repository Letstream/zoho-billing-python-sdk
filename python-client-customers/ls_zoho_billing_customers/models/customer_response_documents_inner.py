...
class CustomerResponseDocumentsInner(BaseModel):
    """
    CustomerResponseDocumentsInner
    """ # noqa: E501
    can_show_in_portal: Optional[Any] = Field(default=None, description="Set to true if the attachment can be viewed in Client Portal.")
    ...
    __properties: ClassVar[List[str]] = ["can_show_in_portal", "file_name", "file_type", "file_size", "file_size_formatted", "document_id", "attachment_order"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if can_show_in_portal (nullable) is None
        # and model_fields_set contains the field
        if self.can_show_in_portal is None and "can_show_in_portal" in self.model_fields_set:
            _dict['can_show_in_portal'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "can_show_in_portal": obj.get("can_show_in_portal"),
