...
class CustomerResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customer_id", "display_name", "salutation", "first_name", "last_name", "email", "tags", "company_name", "phone", "mobile", "website", "is_portal_enabled", "department", "designation", "billing_address", "shipping_address", "currency_code", "currency_id", "ach_supported", "twitter", "facebook", "skype", "notes", "gst_no", "gst_treatment", "tax_reg_no", "tds_tax_id", "tax_treatment", "tax_regime", "is_tds_registered", "place_of_contact", "price_precision", "unused_credits", "outstanding", "status", "custom_fields", "zcrm_account_id", "zcrm_contact_id", "updated_time", "created_time", "source", "payment_terms", "payment_terms_label", "is_linked_with_zohocrm", "primary_contactperson_id", "can_add_card", "can_add_bank_account", "default_templates", "documents"]
