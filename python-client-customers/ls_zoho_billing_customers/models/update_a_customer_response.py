...
class UpdateACustomerResponse(BaseModel):
    """
    UpdateACustomerResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    customer: Optional[UpdateACustomerResponseCustomer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": UpdateACustomerResponseCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
