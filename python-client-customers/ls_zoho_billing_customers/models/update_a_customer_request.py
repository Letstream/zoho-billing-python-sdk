...
class UpdateACustomerRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["display_name", "salutation", "first_name", "last_name", "email", "tags", "company_name", "phone", "mobile", "billing_address", "shipping_address", "fax", "currency_code", "twitter", "facebook", "skype", "is_portal_enabled", "gst_no", "gst_treatment", "place_of_contact", "vat_treatment", "vat_reg_no", "is_taxable", "tax_id", "tax_authority_id", "tax_authority_name", "tax_exemption_id", "tax_exemption_code", "default_templates", "tax_reg_no", "tds_tax_id", "tax_treatment", "tax_regime", "is_tds_registered", "custom_fields"]
