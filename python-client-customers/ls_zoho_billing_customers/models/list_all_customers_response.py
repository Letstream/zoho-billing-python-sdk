...
class ListAllCustomersResponse(BaseModel):
    ...
    customers: Optional[List[ListAllCustomersResponseCustomersInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "customers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customers": [ListAllCustomersResponseCustomersInner.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None
        })
        return _obj
