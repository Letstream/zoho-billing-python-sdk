...
class RetrieveACustomerResponse(BaseModel):
    """
    RetrieveACustomerResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    customer: Optional[RetrieveACustomerResponseCustomer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": RetrieveACustomerResponseCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
