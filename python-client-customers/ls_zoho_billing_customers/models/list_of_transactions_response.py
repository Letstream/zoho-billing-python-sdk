...
class ListOfTransactionsResponse(BaseModel):
    """
    ListOfTransactionsResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    transactions: Optional[List[ListOfTransactionsResponseTransactionsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [ListOfTransactionsResponseTransactionsInner.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
