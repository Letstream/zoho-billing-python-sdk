...
class RetrieveACustomerUsingCrmReferenceResponse(BaseModel):
    """
    RetrieveACustomerUsingCrmReferenceResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    customer: Optional[RetrieveACustomerUsingCrmReferenceResponseCustomer] = None
    __properties: ClassVar[List[str]] = ["code", "message", "customer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": RetrieveACustomerUsingCrmReferenceResponseCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
