...
class TestCreateACustomerResponse(unittest.TestCase):
    """CreateACustomerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateACustomerResponse:
        """Test CreateACustomerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateACustomerResponse`
        """
        model = CreateACustomerResponse()
        if include_optional:
            return CreateACustomerResponse(
                code = 0,
                message = 'The customer has been created',
                customer = ls_zoho_billing_customers.models.customer_response.customer-response(
    ...
    def testCreateACustomerResponse(self):
        """Test CreateACustomerResponse"""
