...
class TestAssignUsersResponseUsersInner(unittest.TestCase):
    """AssignUsersResponseUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignUsersResponseUsersInner:
        """Test AssignUsersResponseUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignUsersResponseUsersInner`
        """
        model = AssignUsersResponseUsersInner()
        if include_optional:
            return AssignUsersResponseUsersInner(
    ...
    def testAssignUsersResponseUsersInner(self):
        """Test AssignUsersResponseUsersInner"""
