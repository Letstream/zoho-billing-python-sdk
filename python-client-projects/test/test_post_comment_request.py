...
class TestPostCommentRequest(unittest.TestCase):
    """PostCommentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostCommentRequest:
        """Test PostCommentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostCommentRequest`
        """
    ...
    def testPostCommentRequest(self):
        """Test PostCommentRequest"""
