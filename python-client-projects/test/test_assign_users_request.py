...
class TestAssignUsersRequest(unittest.TestCase):
    """AssignUsersRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignUsersRequest:
        """Test AssignUsersRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignUsersRequest`
        """
    ...
    def testAssignUsersRequest(self):
        """Test AssignUsersRequest"""
