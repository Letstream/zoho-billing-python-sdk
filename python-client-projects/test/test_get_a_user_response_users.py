...
class TestGetAUserResponseUsers(unittest.TestCase):
    """GetAUserResponseUsers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAUserResponseUsers:
        """Test GetAUserResponseUsers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAUserResponseUsers`
        """
        model = GetAUserResponseUsers()
        if include_optional:
            return GetAUserResponseUsers(
    ...
    def testGetAUserResponseUsers(self):
        """Test GetAUserResponseUsers"""
