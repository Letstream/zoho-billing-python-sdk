...
class TestUpdateAProjectResponse(unittest.TestCase):
    """UpdateAProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAProjectResponse:
        """Test UpdateAProjectResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAProjectResponse`
        """
        model = UpdateAProjectResponse()
        if include_optional:
            return UpdateAProjectResponse(
                code = 0,
                message = 'The project information has been updated.',
                project = ls_zoho_billing_projects.models.update_a_project_response_project.update_a_project_response_project(
    ...
    def testUpdateAProjectResponse(self):
        """Test UpdateAProjectResponse"""
