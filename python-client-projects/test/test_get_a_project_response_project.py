...
class TestGetAProjectResponseProject(unittest.TestCase):
    """GetAProjectResponseProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAProjectResponseProject:
        """Test GetAProjectResponseProject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAProjectResponseProject`
        """
        model = GetAProjectResponseProject()
        if include_optional:
            return GetAProjectResponseProject(
    ...
    def testGetAProjectResponseProject(self):
        """Test GetAProjectResponseProject"""
