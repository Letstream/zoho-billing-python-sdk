...
class TestCreateAProjectRequestUsersInner(unittest.TestCase):
    """CreateAProjectRequestUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAProjectRequestUsersInner:
        """Test CreateAProjectRequestUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAProjectRequestUsersInner`
        """
        model = CreateAProjectRequestUsersInner()
        if include_optional:
            return CreateAProjectRequestUsersInner(
    ...
    def testCreateAProjectRequestUsersInner(self):
        """Test CreateAProjectRequestUsersInner"""
