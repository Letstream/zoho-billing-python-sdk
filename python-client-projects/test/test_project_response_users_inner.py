...
class TestProjectResponseUsersInner(unittest.TestCase):
    """ProjectResponseUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectResponseUsersInner:
        """Test ProjectResponseUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectResponseUsersInner`
        """
        model = ProjectResponseUsersInner()
        if include_optional:
            return ProjectResponseUsersInner(
    ...
    def testProjectResponseUsersInner(self):
        """Test ProjectResponseUsersInner"""
