...
class TestProjectResponseTasksInner(unittest.TestCase):
    """ProjectResponseTasksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectResponseTasksInner:
        """Test ProjectResponseTasksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectResponseTasksInner`
        """
        model = ProjectResponseTasksInner()
        if include_optional:
            return ProjectResponseTasksInner(
    ...
    def testProjectResponseTasksInner(self):
        """Test ProjectResponseTasksInner"""
