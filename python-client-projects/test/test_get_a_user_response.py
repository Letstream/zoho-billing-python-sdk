...
class TestGetAUserResponse(unittest.TestCase):
    """GetAUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAUserResponse:
        """Test GetAUserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAUserResponse`
        """
        model = GetAUserResponse()
        if include_optional:
            return GetAUserResponse(
                code = 0,
                message = 'success',
                users = ls_zoho_billing_projects.models.get_a_user_response_users.get_a_user_response_users(
