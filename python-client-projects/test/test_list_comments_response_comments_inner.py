...
class TestListCommentsResponseCommentsInner(unittest.TestCase):
    """ListCommentsResponseCommentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCommentsResponseCommentsInner:
        """Test ListCommentsResponseCommentsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCommentsResponseCommentsInner`
        """
        model = ListCommentsResponseCommentsInner()
        if include_optional:
            return ListCommentsResponseCommentsInner(
    ...
    def testListCommentsResponseCommentsInner(self):
        """Test ListCommentsResponseCommentsInner"""
