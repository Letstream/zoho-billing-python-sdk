...
class TestListProjectsResponseProjectsInner(unittest.TestCase):
    """ListProjectsResponseProjectsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListProjectsResponseProjectsInner:
        """Test ListProjectsResponseProjectsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListProjectsResponseProjectsInner`
        """
        model = ListProjectsResponseProjectsInner()
        if include_optional:
            return ListProjectsResponseProjectsInner(
    ...
    def testListProjectsResponseProjectsInner(self):
        """Test ListProjectsResponseProjectsInner"""
