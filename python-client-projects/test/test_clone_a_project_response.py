...
class TestCloneAProjectResponse(unittest.TestCase):
    """CloneAProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloneAProjectResponse:
        """Test CloneAProjectResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloneAProjectResponse`
        """
        model = CloneAProjectResponse()
        if include_optional:
            return CloneAProjectResponse(
                code = 0,
    ...
    def testCloneAProjectResponse(self):
        """Test CloneAProjectResponse"""
