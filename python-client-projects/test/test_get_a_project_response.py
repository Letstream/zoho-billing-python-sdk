...
class TestGetAProjectResponse(unittest.TestCase):
    """GetAProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAProjectResponse:
        """Test GetAProjectResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAProjectResponse`
        """
        model = GetAProjectResponse()
        if include_optional:
            return GetAProjectResponse(
                code = 0,
                message = 'success',
                project = ls_zoho_billing_projects.models.get_a_project_response_project.get_a_project_response_project(
    ...
    def testGetAProjectResponse(self):
        """Test GetAProjectResponse"""
