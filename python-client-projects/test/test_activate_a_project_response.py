...
class TestActivateAProjectResponse(unittest.TestCase):
    """ActivateAProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivateAProjectResponse:
        """Test ActivateAProjectResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivateAProjectResponse`
        """
        model = ActivateAProjectResponse()
        if include_optional:
            return ActivateAProjectResponse(
                code = 0,
    ...
    def testActivateAProjectResponse(self):
        """Test ActivateAProjectResponse"""
