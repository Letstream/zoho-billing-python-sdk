...
class TestUpdateAProjectResponseProject(unittest.TestCase):
    """UpdateAProjectResponseProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAProjectResponseProject:
        """Test UpdateAProjectResponseProject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAProjectResponseProject`
        """
        model = UpdateAProjectResponseProject()
        if include_optional:
            return UpdateAProjectResponseProject(
    ...
    def testUpdateAProjectResponseProject(self):
        """Test UpdateAProjectResponseProject"""
