...
class TestUpdateAProjectRequest(unittest.TestCase):
    """UpdateAProjectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAProjectRequest:
        """Test UpdateAProjectRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAProjectRequest`
        """
        model = UpdateAProjectRequest()
        if include_optional:
            return UpdateAProjectRequest(
    ...
    def testUpdateAProjectRequest(self):
        """Test UpdateAProjectRequest"""
