...
class TestDeactivateAProjectResponse(unittest.TestCase):
    """DeactivateAProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeactivateAProjectResponse:
        """Test DeactivateAProjectResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeactivateAProjectResponse`
        """
        model = DeactivateAProjectResponse()
        if include_optional:
            return DeactivateAProjectResponse(
                code = 0,
    ...
    def testDeactivateAProjectResponse(self):
        """Test DeactivateAProjectResponse"""
