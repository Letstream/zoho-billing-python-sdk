...
class TestCreateAProjectRequestTasksInner(unittest.TestCase):
    """CreateAProjectRequestTasksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAProjectRequestTasksInner:
        """Test CreateAProjectRequestTasksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAProjectRequestTasksInner`
        """
        model = CreateAProjectRequestTasksInner()
        if include_optional:
            return CreateAProjectRequestTasksInner(
                task_name = 'INV-00003',
    ...
    def testCreateAProjectRequestTasksInner(self):
        """Test CreateAProjectRequestTasksInner"""
