...
class ListCommentsResponseCommentsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment_id", "project_id", "description", "commented_by_id", "commented_by", "is_current_user", "date", "date_description", "time"]
