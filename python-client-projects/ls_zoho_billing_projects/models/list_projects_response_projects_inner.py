...
class ListProjectsResponseProjectsInner(BaseModel):
    """
    ...
    has_attachment: Optional[StrictBool] = Field(default=None, description="attached bills, receipts etc.")
    ...
    __properties: ClassVar[List[str]] = ["project_id", "project_name", "customer_id", "customer_name", "description", "status", "billing_type", "rate", "created_time", "has_attachment", "total_hours", "billable_hours"]
