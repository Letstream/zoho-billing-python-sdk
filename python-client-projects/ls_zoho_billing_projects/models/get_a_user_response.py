...
class GetAUserResponse(BaseModel):
    """
    GetAUserResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    users: Optional[GetAUserResponseUsers] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": GetAUserResponseUsers.from_dict(obj["users"]) if obj.get("users") is not None else None
        })
        return _obj
