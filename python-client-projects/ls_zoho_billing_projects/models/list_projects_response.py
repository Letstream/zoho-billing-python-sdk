...
class ListProjectsResponse(BaseModel):
    ...
    projects: Optional[List[ListProjectsResponseProjectsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "projects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "projects": [ListProjectsResponseProjectsInner.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
        return _obj
