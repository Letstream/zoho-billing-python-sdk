...
class PostCommentResponse(BaseModel):
    ...
    comments: Optional[List[PostCommentResponseCommentsInner]] = Field(default=None, description="A short noteon the project")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comments": [PostCommentResponseCommentsInner.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None
        })
        return _obj
