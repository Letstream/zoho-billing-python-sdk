...
class CreateAProjectRequestTasksInner(BaseModel):
    """
    CreateAProjectRequestTasksInner
    """ # noqa: E501
    task_name: StrictStr = Field(description="Name of the task. <code>Maximum length [100]</code>")
    description: Optional[StrictStr] = Field(default=None, description="Task description. <code>Maximum length [500]</code>")
    rate: Optional[StrictStr] = Field(default=None, description="Hourly rate of a task.")
    budget_hours: Optional[StrictStr] = Field(default=None, description="Task budgeting.")
    __properties: ClassVar[List[str]] = ["task_name", "description", "rate", "budget_hours"]
