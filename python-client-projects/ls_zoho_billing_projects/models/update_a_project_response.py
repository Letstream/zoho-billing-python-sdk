...
class UpdateAProjectResponse(BaseModel):
    """
    UpdateAProjectResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    project: Optional[UpdateAProjectResponseProject] = None
    __properties: ClassVar[List[str]] = ["code", "message", "project"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "project": UpdateAProjectResponseProject.from_dict(obj["project"]) if obj.get("project") is not None else None
        })
        return _obj
