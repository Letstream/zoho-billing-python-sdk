...
class UpdateUserResponse(BaseModel):
    ...
    users: Optional[List[InviteUserResponseUsersInner]] = Field(default=None, description="Users of a project")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [InviteUserResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
