...
class AssignUsersResponse(BaseModel):
    ...
    users: Optional[List[AssignUsersResponseUsersInner]] = Field(default=None, description="Users of a project")
    __properties: ClassVar[List[str]] = ["code", "message", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [AssignUsersResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
