...
class InviteUserRequest(BaseModel):
    ...
    InviteUserRequest
    """ # noqa: E501
    user_name: StrictStr = Field(description="Name of the user. <code>Maximum length [200]</code>")
    email: StrictStr = Field(description="Email of the user. <code>Maximum length [100]</code>")
    ...
    __properties: ClassVar[List[str]] = ["user_name", "email", "user_role", "rate", "budget_hours"]
