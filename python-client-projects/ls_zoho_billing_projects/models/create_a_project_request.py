...
class CreateAProjectRequest(BaseModel):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description="Project description. <code>Maximu length [500]</code>")
    ...
    rate: Optional[StrictStr] = Field(default=None, description="Rate of the Project. <br>Mandatory for projects whose billing_type is either <code>fixed_cost_for_project</code> or <code>based_on_project_hours</code>")
