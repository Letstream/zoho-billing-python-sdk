...
class GetAProjectResponseProject(BaseModel):
    """
    Name of the project
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["project_id", "project_name", "customer_id", "customer_name", "currency_code", "description", "status", "billing_type", "rate", "budget_type", "total_hours", "total_amount", "billed_hours", "billed_amount", "un_billed_hours", "un_billed_amount", "billable_hours", "billable_amount", "non_billable_hours", "non_billable_amount", "created_time", "show_in_dashboard", "tasks"]
