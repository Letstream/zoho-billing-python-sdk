...
class GetAProjectResponse(BaseModel):
    """
    GetAProjectResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    project: Optional[GetAProjectResponseProject] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "project": GetAProjectResponseProject.from_dict(obj["project"]) if obj.get("project") is not None else None
        })
        return _obj
