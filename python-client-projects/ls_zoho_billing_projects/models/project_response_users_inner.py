...
class ProjectResponseUsersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user_id", "is_current_user", "user_name", "email", "user_role", "status", "rate", "budget_hours", "total_hours", "billed_hours", "un_billed_hours"]
