...
change_to_onlineoffline_mode_response_subscription_instance = ChangeToOnlineofflineModeResponseSubscription.from_json(json)
# print the JSON string representation of the object
print(ChangeToOnlineofflineModeResponseSubscription.to_json())

# convert the object into a dict
change_to_onlineoffline_mode_response_subscription_dict = change_to_onlineoffline_mode_response_subscription_instance.to_dict()
# create an instance of ChangeToOnlineofflineModeResponseSubscription from a dict
change_to_onlineoffline_mode_response_subscription_from_dict = ChangeToOnlineofflineModeResponseSubscription.from_dict(change_to_onlineoffline_mode_response_subscription_dict)
```
