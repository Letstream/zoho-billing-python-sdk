...
**card** | [**UpdateCardResponseSubscriptionCard**](UpdateCardResponseSubscriptionCard.md) |  | [optional] 
...
update_card_response_subscription_instance = UpdateCardResponseSubscription.from_json(json)
# print the JSON string representation of the object
print(UpdateCardResponseSubscription.to_json())

# convert the object into a dict
update_card_response_subscription_dict = update_card_response_subscription_instance.to_dict()
# create an instance of UpdateCardResponseSubscription from a dict
update_card_response_subscription_from_dict = UpdateCardResponseSubscription.from_dict(update_card_response_subscription_dict)
```
