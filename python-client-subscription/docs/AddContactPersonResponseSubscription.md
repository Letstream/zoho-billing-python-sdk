...
**addons** | [**List[AddContactPersonResponseSubscriptionAddonsInner]**](AddContactPersonResponseSubscriptionAddonsInner.md) | List of addon objects which are to be included in the subscription. Each object contains &lt;code&gt;addon_code&lt;/code&gt;, &lt;code&gt;name&lt;/code&gt;, &lt;code&gt;price&lt;/code&gt; and &lt;code&gt;quantity&lt;/code&gt;. | [optional] 
...
**customer** | [**UpdateCardResponseSubscriptionCustomer**](UpdateCardResponseSubscriptionCustomer.md) |  | [optional] 
...
add_contact_person_response_subscription_instance = AddContactPersonResponseSubscription.from_json(json)
# print the JSON string representation of the object
print(AddContactPersonResponseSubscription.to_json())

# convert the object into a dict
add_contact_person_response_subscription_dict = add_contact_person_response_subscription_instance.to_dict()
# create an instance of AddContactPersonResponseSubscription from a dict
add_contact_person_response_subscription_from_dict = AddContactPersonResponseSubscription.from_dict(add_contact_person_response_subscription_dict)
```
