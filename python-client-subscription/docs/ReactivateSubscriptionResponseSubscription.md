...
**plan** | [**ReactivateSubscriptionResponseSubscriptionPlan**](ReactivateSubscriptionResponseSubscriptionPlan.md) |  | [optional] 
**addons** | [**List[ReactivateSubscriptionResponseSubscriptionAddonsInner]**](ReactivateSubscriptionResponseSubscriptionAddonsInner.md) | List of addon objects which are to be included in the subscription. Each object contains &lt;code&gt;addon_code&lt;/code&gt;, &lt;code&gt;name&lt;/code&gt;, &lt;code&gt;price&lt;/code&gt; and &lt;code&gt;quantity&lt;/code&gt;. | [optional] 
...
**notes** | [**List[ReactivateSubscriptionResponseSubscriptionNotesInner]**](ReactivateSubscriptionResponseSubscriptionNotesInner.md) | List of objects containing &lt;code&gt;note_id&lt;/code&gt;, &lt;code&gt;description&lt;/code&gt;, &lt;code&gt;commented_by&lt;/code&gt; and &lt;code&gt;commented_time&lt;/code&gt; | [optional] 
...
reactivate_subscription_response_subscription_instance = ReactivateSubscriptionResponseSubscription.from_json(json)
# print the JSON string representation of the object
print(ReactivateSubscriptionResponseSubscription.to_json())

# convert the object into a dict
reactivate_subscription_response_subscription_dict = reactivate_subscription_response_subscription_instance.to_dict()
# create an instance of ReactivateSubscriptionResponseSubscription from a dict
reactivate_subscription_response_subscription_from_dict = ReactivateSubscriptionResponseSubscription.from_dict(reactivate_subscription_response_subscription_dict)
```
