...
class AddonsInner(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=1, description="Required quantity of the chosen addon.")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=10, description="A value can be provided here if the per unit addon price has to be overridden for this subscription.")
    discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discount applied for the addon.")
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount for the addon.")
    tax_id: Optional[StrictStr] = Field(default=None, description="Unique ID of the tax applied for the addon.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": obj.get("price") if obj.get("price") is not None else 10,
