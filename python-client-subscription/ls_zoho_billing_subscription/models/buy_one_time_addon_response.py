...
class BuyOneTimeAddonResponse(BaseModel):
    """
    BuyOneTimeAddonResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    invoice: Optional[BuyOneTimeAddonResponseInvoice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice": BuyOneTimeAddonResponseInvoice.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
