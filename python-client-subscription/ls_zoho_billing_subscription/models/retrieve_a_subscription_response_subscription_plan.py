...
class RetrieveASubscriptionResponseSubscriptionPlan(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "name", "quantity", "item_custom_fields", "price", "tags", "discount", "total", "setup_fee", "plan_description", "tax_id", "trial_days"]
