...
class RetrieveASubscriptionResponseSubscription(BaseModel):
    """
    ...
    unbilled_charge_id: Optional[StrictStr] = Field(default=None, description="A unique ID if the subscription has any unbilled charges for the duration.")
    ...
    plan: Optional[RetrieveASubscriptionResponseSubscriptionPlan] = None
    addons: Optional[List[RetrieveASubscriptionResponseSubscriptionAddonsInner]] = Field(default=None, description="List of addon objects which are to be included in the subscription. Each object contains <code>addon_code</code>, <code>name</code>, <code>price</code> and <code>quantity</code>.")
    coupon: Optional[SubscriptionResponseCoupon] = None
    card: Optional[RetrieveASubscriptionResponseSubscriptionCard] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plan": RetrieveASubscriptionResponseSubscriptionPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None,
            "addons": [RetrieveASubscriptionResponseSubscriptionAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None,
            "coupon": SubscriptionResponseCoupon.from_dict(obj["coupon"]) if obj.get("coupon") is not None else None,
            "card": RetrieveASubscriptionResponseSubscriptionCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
