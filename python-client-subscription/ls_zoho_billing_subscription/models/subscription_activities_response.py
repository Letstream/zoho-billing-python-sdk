...
class SubscriptionActivitiesResponse(BaseModel):
    """
    SubscriptionActivitiesResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    activities: Optional[List[SubscriptionActivitiesResponseActivitiesInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "activities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activities": [SubscriptionActivitiesResponseActivitiesInner.from_dict(_item) for _item in obj["activities"]] if obj.get("activities") is not None else None
        })
        return _obj
