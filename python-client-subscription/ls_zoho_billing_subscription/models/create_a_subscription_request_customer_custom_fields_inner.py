...
class CreateASubscriptionRequestCustomerCustomFieldsInner(BaseModel):
    """
    CreateASubscriptionRequestCustomerCustomFieldsInner
    """ # noqa: E501
    label: StrictStr = Field(description="Label of the Custom Field")
    value: StrictStr = Field(description="Value of the Custom Field")
