...
class UpdateCustomFieldsResponseData(BaseModel):
    """
    UpdateCustomFieldsResponseData
    """ # noqa: E501
    index: Optional[StrictInt] = Field(default=None, description="Index of the custom field. It can hold any value from 1 to 10.")
    ...
    customfield_id: Optional[StrictStr] = Field(default=None, description="Unique ID to denote the custom field.")
    __properties: ClassVar[List[str]] = ["index", "value", "label", "data_type", "customfield_id"]
