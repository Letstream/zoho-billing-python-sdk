...
class CreateASubscriptionRequestPlan(BaseModel):
    """
    ...
    setup_fee_tax_id: Optional[StrictStr] = Field(default=None, description="Unique ID for tax of setup fee. <code>setup_fee_tax_id</code> must be empty for applying tax Exemption.")
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "plan_description", "price", "setup_fee", "setup_fee_tax_id", "tags", "item_custom_fields", "quantity", "tax_id", "tax_exemption_id", "tax_exemption_code", "tds_tax_id", "sat_item_key_code", "unitkey_code", "setup_fee_tax_exemption_id", "setup_fee_tax_exemption_code", "exclude_trial", "exclude_setup_fee", "billing_cycles", "trial_days"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "setup_fee_tax_id": obj.get("setup_fee_tax_id"),
