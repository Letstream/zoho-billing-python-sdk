...
class CreateASubscriptionRequestContactpersonsInner(BaseModel):
    """
    CreateASubscriptionRequestContactpersonsInner
    """ # noqa: E501
    contactperson_id: StrictStr = Field(description="Contact person ID of the customer’s contact person.")
    __properties: ClassVar[List[str]] = ["contactperson_id"]
