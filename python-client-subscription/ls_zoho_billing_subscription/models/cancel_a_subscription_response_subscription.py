...
class CancelASubscriptionResponseSubscription(BaseModel):
    """
    ...
    customer: Optional[CancelASubscriptionResponseSubscriptionCustomer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": CancelASubscriptionResponseSubscriptionCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
