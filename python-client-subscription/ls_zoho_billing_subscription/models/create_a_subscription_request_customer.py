...
class CreateASubscriptionRequestCustomer(BaseModel):
    ...
    custom_fields: Optional[List[CreateASubscriptionRequestCustomerCustomFieldsInner]] = Field(default=None, description="Additional fields for the invoices.")
    ...
    __properties: ClassVar[List[str]] = ["display_name", "salutation", "first_name", "last_name", "email", "company_name", "billing_address", "shipping_address", "payment_terms", "payment_terms_label", "custom_fields", "place_of_contact", "gst_no", "gst_treatment", "vat_treatment", "vat_reg_no", "country_code", "is_taxable", "tax_id", "tax_authority_id", "tax_authority_name", "tax_exemption_id", "tax_exemption_code"]
