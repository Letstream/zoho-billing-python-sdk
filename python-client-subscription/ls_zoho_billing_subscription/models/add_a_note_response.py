...
class AddANoteResponse(BaseModel):
    """
    AddANoteResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    note: Optional[AddANoteResponseNote] = None
    __properties: ClassVar[List[str]] = ["code", "message", "note"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note": AddANoteResponseNote.from_dict(obj["note"]) if obj.get("note") is not None else None
        })
        return _obj
