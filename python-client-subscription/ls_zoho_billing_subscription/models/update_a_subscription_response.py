...
class UpdateASubscriptionResponse(BaseModel):
    ...
    subscription: Optional[UpdateASubscriptionResponseSubscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscription": UpdateASubscriptionResponseSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
