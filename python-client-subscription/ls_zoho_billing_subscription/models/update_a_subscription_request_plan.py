...
class UpdateASubscriptionRequestPlan(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "plan_description", "price", "setup_fee", "quantity", "tags", "item_custom_fields", "tax_id", "tax_exemption_id", "tax_exemption_code", "tds_tax_id", "sat_item_key_code", "unitkey_code", "setup_fee_tax_exemption_id", "setup_fee_tax_exemption_code", "exclude_trial", "exclude_setup_fee", "billing_cycles", "trial_days"]
