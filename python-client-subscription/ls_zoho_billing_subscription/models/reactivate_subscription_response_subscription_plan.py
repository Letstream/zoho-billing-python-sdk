...
class ReactivateSubscriptionResponseSubscriptionPlan(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["plan_code", "name", "quantity", "price", "tags", "item_custom_fields", "discount", "total", "setup_fee", "plan_description", "billing_cycles", "trial_days"]
