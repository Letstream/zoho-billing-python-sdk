...
class AddContactPersonRequest(BaseModel):
    """
    AddContactPersonRequest
    """ # noqa: E501
    contactpersons: List[CreateASubscriptionRequestContactpersonsInner] = Field(description="List of contact person objects. Each object contains <code>contactperson_id</code>.")
    __properties: ClassVar[List[str]] = ["contactpersons"]
