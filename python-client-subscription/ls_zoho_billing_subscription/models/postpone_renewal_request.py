...
class PostponeRenewalRequest(BaseModel):
    """
    PostponeRenewalRequest
    """ # noqa: E501
    renewal_at: StrictStr = Field(description="Enter the future date to which the subscription renewal has to be postponed.")
    __properties: ClassVar[List[str]] = ["renewal_at"]
