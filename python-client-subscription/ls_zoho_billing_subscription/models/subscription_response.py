...
class SubscriptionResponse(BaseModel):
    ...
    addons: Optional[List[SubscriptionResponseAddonsInner]] = Field(default=None, description="List of addon objects which are to be included in the subscription. Each object contains <code>addon_code</code>, <code>name</code>, <code>price</code> and <code>quantity</code>.")
    ...
    customer: Optional[SubscriptionResponseCustomer] = None
    ...
    __properties: ClassVar[List[str]] = ["subscription_id", "name", "status", "amount", "created_at", "activated_at", "current_term_starts_at", "current_term_ends_at", "last_billing_at", "next_billing_at", "expires_at", "interval", "interval_unit", "auto_collect", "created_time", "updated_time", "reference_id", "place_of_supply", "salesperson_id", "salesperson_name", "child_invoice_id", "currency_code", "currency_symbol", "end_of_term", "product_id", "product_name", "plan", "addons", "coupon", "card", "payment_terms", "payment_terms_label", "can_add_bank_account", "customer", "custom_fields", "taxes", "contactpersons", "notes", "payment_gateways", "unbilled_charge_id", "can_charge_setup_fee_immediately"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addons": [SubscriptionResponseAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None,
            ...
            "customer": SubscriptionResponseCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
