...
class ReactivateSubscriptionResponseSubscriptionAddonsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addon_code", "name", "addon_description", "quantity", "tags", "item_custom_fields", "price", "discount", "total"]
