...
class ListAllSubscriptionsResponse(BaseModel):
    ...
    subscriptions: Optional[List[ListAllSubscriptionsResponseSubscriptionsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "subscriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [ListAllSubscriptionsResponseSubscriptionsInner.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
        return _obj
