...
class ReactivateSubscriptionResponseSubscription(BaseModel):
    """
    ...
    plan: Optional[ReactivateSubscriptionResponseSubscriptionPlan] = None
    addons: Optional[List[ReactivateSubscriptionResponseSubscriptionAddonsInner]] = Field(default=None, description="List of addon objects which are to be included in the subscription. Each object contains <code>addon_code</code>, <code>name</code>, <code>price</code> and <code>quantity</code>.")
    ...
    customer: Optional[RetrieveASubscriptionResponseSubscriptionCustomer] = None
    ...
    notes: Optional[List[ReactivateSubscriptionResponseSubscriptionNotesInner]] = Field(default=None, description="List of objects containing <code>note_id</code>, <code>description</code>, <code>commented_by</code> and <code>commented_time</code>")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReactivateSubscriptionResponseSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReactivateSubscriptionResponseSubscription from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "plan": ReactivateSubscriptionResponseSubscriptionPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None,
            "addons": [ReactivateSubscriptionResponseSubscriptionAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None,
            ...
            "customer": RetrieveASubscriptionResponseSubscriptionCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            ...
            "notes": [ReactivateSubscriptionResponseSubscriptionNotesInner.from_dict(_item) for _item in obj["notes"]] if obj.get("notes") is not None else None,
