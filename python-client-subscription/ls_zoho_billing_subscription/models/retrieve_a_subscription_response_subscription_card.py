...
class RetrieveASubscriptionResponseSubscriptionCard(BaseModel):
    """
    ...
    is_primary: Optional[StrictBool] = Field(default=None, description="Card is marked as Primary")
    is_backup: Optional[StrictBool] = Field(default=None, description="Card is marked as Backup")
    __properties: ClassVar[List[str]] = ["card_id", "last_four_digits", "payment_gateway", "expiry_month", "expiry_year", "is_primary", "is_backup"]
