...
class CancelASubscriptionResponseSubscriptionCustomer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["customer_id", "display_name", "salutation", "first_name", "last_name", "email", "company_name", "billing_address", "shipping_address", "payment_terms", "payment_terms_label"]
