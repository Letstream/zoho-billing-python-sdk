...
class AddChargeResponseInvoiceInvoiceItemsInner(BaseModel):
    """
    ...
    name: Optional[Any] = Field(default=None, description="Name generated by concatenation of the product name and the selected plan.")
    ...
    account_name: Optional[StrictStr] = Field(default=None, description="Account Name which the add charge is associated.")
    __properties: ClassVar[List[str]] = ["item_id", "name", "description", "code", "price", "quantity", "tags", "item_custom_fields", "item_total", "account_id", "account_name"]
