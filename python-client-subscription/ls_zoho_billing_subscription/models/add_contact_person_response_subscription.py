...
class AddContactPersonResponseSubscription(BaseModel):
    """
    ...
    addons: Optional[List[AddContactPersonResponseSubscriptionAddonsInner]] = Field(default=None, description="List of addon objects which are to be included in the subscription. Each object contains <code>addon_code</code>, <code>name</code>, <code>price</code> and <code>quantity</code>.")
    coupon: Optional[SubscriptionResponseCoupon] = None
    card: Optional[SubscriptionResponseCard] = None
    ...
    customer: Optional[UpdateCardResponseSubscriptionCustomer] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddContactPersonResponseSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddContactPersonResponseSubscription from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "addons": [AddContactPersonResponseSubscriptionAddonsInner.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None,
            "coupon": SubscriptionResponseCoupon.from_dict(obj["coupon"]) if obj.get("coupon") is not None else None,
            "card": SubscriptionResponseCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
            ...
            "customer": UpdateCardResponseSubscriptionCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
