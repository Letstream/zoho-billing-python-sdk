...
class CreateASubscriptionRequestAddonsInner(BaseModel):
    """
    ...
    quantity: Optional[Any] = Field(default=None, description="Required quantity of the chosen addon.")
    ...
    __properties: ClassVar[List[str]] = ["addon_code", "addon_description", "price", "quantity", "tags", "item_custom_fields", "tax_id", "tax_exemption_id", "tax_exemption_code", "tds_tax_id", "sat_item_key_code", "unitkey_code"]
