...
class CancelASubscriptionResponse(BaseModel):
    """
    CancelASubscriptionResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    subscription: Optional[CancelASubscriptionResponseSubscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscription": CancelASubscriptionResponseSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
