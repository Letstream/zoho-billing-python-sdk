...
class AddeditDescriptionForAItemInLineItemsListRequest(BaseModel):
    """
    AddeditDescriptionForAItemInLineItemsListRequest
    """ # noqa: E501
    description: Optional[Any] = Field(description="Make a note of why the customer was charged so that if can be used for any future reference.")
