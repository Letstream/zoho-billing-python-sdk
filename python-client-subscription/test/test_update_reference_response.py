...
class TestUpdateReferenceResponse(unittest.TestCase):
    """UpdateReferenceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateReferenceResponse:
        """Test UpdateReferenceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateReferenceResponse`
        """
        model = UpdateReferenceResponse()
        if include_optional:
    ...
    def testUpdateReferenceResponse(self):
        """Test UpdateReferenceResponse"""
