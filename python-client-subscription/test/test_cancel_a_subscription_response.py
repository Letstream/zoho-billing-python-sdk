...
class TestCancelASubscriptionResponse(unittest.TestCase):
    """CancelASubscriptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelASubscriptionResponse:
        """Test CancelASubscriptionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelASubscriptionResponse`
        """
        model = CancelASubscriptionResponse()
        if include_optional:
            return CancelASubscriptionResponse(
                code = 0,
                message = 'Your subscription will be canceled at the end of this term.',
                subscription = ls_zoho_billing_subscription.models.cancel_a_subscription_response_subscription.cancel_a_subscription_response_subscription(
                    ...
                    customer = ls_zoho_billing_subscription.models.cancel_a_subscription_response_subscription_customer.cancel_a_subscription_response_subscription_customer(
    ...
    def testCancelASubscriptionResponse(self):
        """Test CancelASubscriptionResponse"""
