...
class TestPostponeRenewalResponseSubscription(unittest.TestCase):
    """PostponeRenewalResponseSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostponeRenewalResponseSubscription:
        """Test PostponeRenewalResponseSubscription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostponeRenewalResponseSubscription`
        """
        model = PostponeRenewalResponseSubscription()
        if include_optional:
            return PostponeRenewalResponseSubscription(
    ...
    def testPostponeRenewalResponseSubscription(self):
        """Test PostponeRenewalResponseSubscription"""
