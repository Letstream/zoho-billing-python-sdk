...
class TestSubscriptionResponseAddonsInner(unittest.TestCase):
    """SubscriptionResponseAddonsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionResponseAddonsInner:
        """Test SubscriptionResponseAddonsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionResponseAddonsInner`
        """
        model = SubscriptionResponseAddonsInner()
        if include_optional:
            return SubscriptionResponseAddonsInner(
    ...
    def testSubscriptionResponseAddonsInner(self):
        """Test SubscriptionResponseAddonsInner"""
