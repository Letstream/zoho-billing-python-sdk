...
class TestUpdateSalesPersonResponse(unittest.TestCase):
    """UpdateSalesPersonResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSalesPersonResponse:
        """Test UpdateSalesPersonResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSalesPersonResponse`
        """
        model = UpdateSalesPersonResponse()
        if include_optional:
    ...
    def testUpdateSalesPersonResponse(self):
        """Test UpdateSalesPersonResponse"""
