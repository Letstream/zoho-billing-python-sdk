...
class TestPostponeRenewalResponse(unittest.TestCase):
    """PostponeRenewalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostponeRenewalResponse:
        """Test PostponeRenewalResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostponeRenewalResponse`
        """
        model = PostponeRenewalResponse()
        if include_optional:
            return PostponeRenewalResponse(
                code = 0,
                message = 'Billing date of the subscription has been changed.',
                subscription = ls_zoho_billing_subscription.models.postpone_renewal_response_subscription.postpone_renewal_response_subscription(
                    ...
                    customer = ls_zoho_billing_subscription.models.postpone_renewal_response_subscription_customer.postpone_renewal_response_subscription_customer(
    ...
    def testPostponeRenewalResponse(self):
        """Test PostponeRenewalResponse"""
