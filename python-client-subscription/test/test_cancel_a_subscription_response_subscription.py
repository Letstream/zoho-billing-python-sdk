...
class TestCancelASubscriptionResponseSubscription(unittest.TestCase):
    """CancelASubscriptionResponseSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelASubscriptionResponseSubscription:
        """Test CancelASubscriptionResponseSubscription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelASubscriptionResponseSubscription`
        """
        model = CancelASubscriptionResponseSubscription()
        if include_optional:
            return CancelASubscriptionResponseSubscription(
    ...
    def testCancelASubscriptionResponseSubscription(self):
        """Test CancelASubscriptionResponseSubscription"""
