...
class TestViewScheduledChangesResponse(unittest.TestCase):
    """ViewScheduledChangesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewScheduledChangesResponse:
        """Test ViewScheduledChangesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewScheduledChangesResponse`
        """
        model = ViewScheduledChangesResponse()
        if include_optional:
            return ViewScheduledChangesResponse(
                code = 0,
                message = 'success',
                subscription = ls_zoho_billing_subscription.models.view_scheduled_changes_response_subscription.view_scheduled_changes_response_subscription(
    ...
    def testViewScheduledChangesResponse(self):
        """Test ViewScheduledChangesResponse"""
