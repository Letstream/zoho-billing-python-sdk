...
class TestGetPaymentReminderMailContentResponseData(unittest.TestCase):
    """GetPaymentReminderMailContentResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPaymentReminderMailContentResponseData:
        """Test GetPaymentReminderMailContentResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPaymentReminderMailContentResponseData`
        """
        model = GetPaymentReminderMailContentResponseData()
        if include_optional:
            return GetPaymentReminderMailContentResponseData(
                bcc_mails = [
                    ''
                    ],
    ...
    def testGetPaymentReminderMailContentResponseData(self):
        """Test GetPaymentReminderMailContentResponseData"""
