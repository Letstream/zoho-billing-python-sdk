...
class TestRetrieveAnInvoiceResponse(unittest.TestCase):
    """RetrieveAnInvoiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveAnInvoiceResponse:
        """Test RetrieveAnInvoiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveAnInvoiceResponse`
        """
        model = RetrieveAnInvoiceResponse()
        if include_optional:
            return RetrieveAnInvoiceResponse(
                code = 0,
                message = 'success',
                invoice = ls_zoho_billing_invoices.models.retrieve_an_invoice_response_invoice.retrieve_an_invoice_response_invoice(
    ...
    def testRetrieveAnInvoiceResponse(self):
        """Test RetrieveAnInvoiceResponse"""
