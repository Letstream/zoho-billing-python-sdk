...
class TestUpdateAnInvoiceResponseInvoice(unittest.TestCase):
    """UpdateAnInvoiceResponseInvoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnInvoiceResponseInvoice:
        """Test UpdateAnInvoiceResponseInvoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnInvoiceResponseInvoice`
        """
        model = UpdateAnInvoiceResponseInvoice()
        if include_optional:
            return UpdateAnInvoiceResponseInvoice(
    ...
    def testUpdateAnInvoiceResponseInvoice(self):
        """Test UpdateAnInvoiceResponseInvoice"""
