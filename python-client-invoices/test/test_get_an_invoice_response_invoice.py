...
class TestGetAnInvoiceResponseInvoice(unittest.TestCase):
    """GetAnInvoiceResponseInvoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnInvoiceResponseInvoice:
        """Test GetAnInvoiceResponseInvoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnInvoiceResponseInvoice`
        """
        model = GetAnInvoiceResponseInvoice()
        if include_optional:
            return GetAnInvoiceResponseInvoice(
    ...
    def testGetAnInvoiceResponseInvoice(self):
        """Test GetAnInvoiceResponseInvoice"""
