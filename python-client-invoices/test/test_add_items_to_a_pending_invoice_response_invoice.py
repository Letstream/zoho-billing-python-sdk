...
class TestAddItemsToAPendingInvoiceResponseInvoice(unittest.TestCase):
    """AddItemsToAPendingInvoiceResponseInvoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddItemsToAPendingInvoiceResponseInvoice:
        """Test AddItemsToAPendingInvoiceResponseInvoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddItemsToAPendingInvoiceResponseInvoice`
        """
        model = AddItemsToAPendingInvoiceResponseInvoice()
        if include_optional:
            return AddItemsToAPendingInvoiceResponseInvoice(
    ...
    def testAddItemsToAPendingInvoiceResponseInvoice(self):
        """Test AddItemsToAPendingInvoiceResponseInvoice"""
