...
class TestUpdateAnInvoiceResponse(unittest.TestCase):
    """UpdateAnInvoiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAnInvoiceResponse:
        """Test UpdateAnInvoiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAnInvoiceResponse`
        """
        model = UpdateAnInvoiceResponse()
        if include_optional:
            return UpdateAnInvoiceResponse(
                code = 0,
                message = 'Invoice information has been updated.',
                invoice = ls_zoho_billing_invoices.models.update_an_invoice_response_invoice.update_an_invoice_response_invoice(
                    ...
                    client_viewed_time = '', 
                    invoice_items = [
                        ls_zoho_billing_invoices.models.update_an_invoice_response_invoice_invoice_items_inner.update_an_invoice_response_invoice_invoice_items_inner(
    ...
    def testUpdateAnInvoiceResponse(self):
        """Test UpdateAnInvoiceResponse"""
