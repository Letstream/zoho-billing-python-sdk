...
class TestGetAnInvoiceResponse(unittest.TestCase):
    """GetAnInvoiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnInvoiceResponse:
        """Test GetAnInvoiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnInvoiceResponse`
        """
        model = GetAnInvoiceResponse()
        if include_optional:
            return GetAnInvoiceResponse(
                code = 0,
                message = 'success',
                invoice = ls_zoho_billing_invoices.models.get_an_invoice_response_invoice.get_an_invoice_response_invoice(
                    ...
                    client_viewed_time = '', 
                    line_items = [
                        ls_zoho_billing_invoices.models.get_an_invoice_response_invoice_line_items_inner.get_an_invoice_response_invoice_line_items_inner(
    ...
    def testGetAnInvoiceResponse(self):
        """Test GetAnInvoiceResponse"""
