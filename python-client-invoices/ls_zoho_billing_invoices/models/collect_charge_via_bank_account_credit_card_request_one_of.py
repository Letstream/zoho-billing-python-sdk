...
class CollectChargeViaBankAccountCreditCardRequestOneOf(BaseModel):
    """
    CollectChargeViaBankAccountCreditCardRequestOneOf
    """ # noqa: E501
    account_id: StrictStr = Field(description="Unique ID of the bank account. If you are collecting charge via credit card, use <code>card_id</code> (Card ID of the card associated with the transaction)")
