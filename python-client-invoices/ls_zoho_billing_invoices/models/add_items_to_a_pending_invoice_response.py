...
class AddItemsToAPendingInvoiceResponse(BaseModel):
    """
    AddItemsToAPendingInvoiceResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    invoice: Optional[AddItemsToAPendingInvoiceResponseInvoice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice": AddItemsToAPendingInvoiceResponseInvoice.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
