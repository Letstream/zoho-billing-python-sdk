...
class ListCreditsAppliedResponse(BaseModel):
    """
    ListCreditsAppliedResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    credits: Optional[List[ListCreditsAppliedResponseCreditsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "credits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credits": [ListCreditsAppliedResponseCreditsInner.from_dict(_item) for _item in obj["credits"]] if obj.get("credits") is not None else None
        })
        return _obj
