...
class ApplyCreditsRequestApplyCreditnotesInner(BaseModel):
    """
    ApplyCreditsRequestApplyCreditnotesInner
    """ # noqa: E501
    creditnote_id: Optional[StrictStr] = Field(default=None, description="ID of the credit note from which credit has to be applied.")
    amount_applied: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount applied to the invoice.")
