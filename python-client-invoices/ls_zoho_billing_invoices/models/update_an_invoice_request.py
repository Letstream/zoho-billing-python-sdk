...
class UpdateAnInvoiceRequest(BaseModel):
    """
    ...
    invoice_items: List[UpdateAnInvoiceRequestInvoiceItemsInner] = Field(description="Line items of an invoice.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice_items": [UpdateAnInvoiceRequestInvoiceItemsInner.from_dict(_item) for _item in obj["invoice_items"]] if obj.get("invoice_items") is not None else None,
