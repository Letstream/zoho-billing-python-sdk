...
class PaymentOptions(BaseModel):
    ...
    """ # noqa: E501
    payment_gateways: Optional[List[PaymentGatewaysInner]] = Field(default=None, description="Payment gateways integrated and supported")
    __properties: ClassVar[List[str]] = ["payment_gateways"]
