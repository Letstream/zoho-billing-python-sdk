...
class EmailInvoicesRequest(BaseModel):
    """
    EmailInvoicesRequest
    """ # noqa: E501
    contacts: List[EmailInvoicesRequestContactsInner] = Field(description="Contacts to whom email or snail mail has to be sent.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contacts": [EmailInvoicesRequestContactsInner.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None
        })
        return _obj
