...
class BulkInvoiceReminderResponseInfoEmailErrorsInfoInner(BaseModel):
    """
    ...
    ids: Optional[List[StrictStr]] = Field(default=None, description="ID's of mails sent")
    __properties: ClassVar[List[str]] = ["message", "ids"]
