...
class UpdateCustomFieldsResponse(BaseModel):
    """
    UpdateCustomFieldsResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    custom_fields: Optional[List[UpdateCustomFieldsResponseCustomFieldsInner]] = Field(default=None, description="Additional fields for the invoices.")
    __properties: ClassVar[List[str]] = ["code", "message", "custom_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "custom_fields": [UpdateCustomFieldsResponseCustomFieldsInner.from_dict(_item) for _item in obj["custom_fields"]] if obj.get("custom_fields") is not None else None
        })
        return _obj
