...
class GetAnInvoiceResponseInvoiceLineItemsInner(BaseModel):
    """
    GetAnInvoiceResponseInvoiceLineItemsInner
    """ # noqa: E501
    line_item_id: Optional[StrictStr] = Field(default=None, description="The line item ID")
    ...
    __properties: ClassVar[List[str]] = ["line_item_id", "item_id", "project_id", "project_name", "item_type", "product_type", "time_entry_ids", "expense_id", "expense_receipt_name", "name", "description", "item_order", "bcy_rate", "rate", "price", "quantity", "unit", "discount_amount", "discount", "tax_id", "tds_tax_id", "tax_name", "tax_type", "tax_percentage", "item_total", "sat_item_key_code", "unitkey_code"]
