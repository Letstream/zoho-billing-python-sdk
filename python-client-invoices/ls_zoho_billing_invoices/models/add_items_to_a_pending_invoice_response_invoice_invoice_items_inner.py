...
class AddItemsToAPendingInvoiceResponseInvoiceInvoiceItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["item_id", "name", "description", "tags", "item_custom_fields", "code", "price", "quantity", "discount_amount", "item_total", "tax_id", "product_type", "hsn_or_sac", "tax_exemption_id", "tax_exemption_code"]
