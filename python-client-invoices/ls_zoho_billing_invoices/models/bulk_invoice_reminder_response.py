...
class BulkInvoiceReminderResponse(BaseModel):
    """
    BulkInvoiceReminderResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    info: Optional[BulkInvoiceReminderResponseInfo] = None
    __properties: ClassVar[List[str]] = ["code", "message", "info"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "info": BulkInvoiceReminderResponseInfo.from_dict(obj["info"]) if obj.get("info") is not None else None
        })
        return _obj
