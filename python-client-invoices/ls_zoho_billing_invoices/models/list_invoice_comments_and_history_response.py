...
class ListInvoiceCommentsAndHistoryResponse(BaseModel):
    """
    ListInvoiceCommentsAndHistoryResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    comments: Optional[List[ListInvoiceCommentsAndHistoryResponseCommentsInner]] = Field(default=None, description="Comments made")
    __properties: ClassVar[List[str]] = ["code", "message", "comments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comments": [ListInvoiceCommentsAndHistoryResponseCommentsInner.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None
        })
        return _obj
