...
class InvoiceResponseInvoiceItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["item_id", "product_id", "project_id", "project_name", "time_entry_ids", "item_type", "product_type", "expense_id", "name", "description", "item_order", "bcy_rate", "price", "quantity", "unit", "discount_amount", "discount", "tax_id", "tds_tax_id", "tax_name", "tax_type", "tax_percentage", "item_total", "sat_item_key_code", "unitkey_code"]
