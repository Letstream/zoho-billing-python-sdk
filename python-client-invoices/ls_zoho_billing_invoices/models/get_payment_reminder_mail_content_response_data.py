...
class GetPaymentReminderMailContentResponseData(BaseModel):
    """
    Date of the email
    """ # noqa: E501
    ...
    body: Optional[StrictStr] = Field(default=None, description="content of email sent")
    ...
    cc_mails_list: Optional[List[GetInvoiceEmailContentResponseDataCcMailsListInner]] = Field(default=None, description="CC'd mail recepients")
    ...
    emailtemplates: Optional[List[GetPaymentReminderMailContentResponseDataEmailtemplatesInner]] = Field(default=None, description="Email templates used")
    emailtemplate_documents: Optional[List[StrictStr]] = Field(default=None, description="Email templates used")
    to_contacts: Optional[List[GetInvoiceEmailContentResponseDataToContactsInner]] = Field(default=None, description="Recepienyts pf the mail")
    ...
    from_emails: Optional[List[GetInvoiceEmailContentResponseDataFromEmailsInner]] = Field(default=None, description="senders email address")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emailtemplates": [GetPaymentReminderMailContentResponseDataEmailtemplatesInner.from_dict(_item) for _item in obj["emailtemplates"]] if obj.get("emailtemplates") is not None else None,
