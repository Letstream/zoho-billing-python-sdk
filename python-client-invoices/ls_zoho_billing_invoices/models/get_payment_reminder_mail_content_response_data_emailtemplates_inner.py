...
class GetPaymentReminderMailContentResponseDataEmailtemplatesInner(BaseModel):
    """
    GetPaymentReminderMailContentResponseDataEmailtemplatesInner
    """ # noqa: E501
    selected: Optional[StrictBool] = Field(default=None, description="Selected or not")
