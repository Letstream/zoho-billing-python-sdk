...
class CollectChargeViaBankAccountCreditCardResponse(BaseModel):
    """
    CollectChargeViaBankAccountCreditCardResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    payment: Optional[CollectChargeViaBankAccountCreditCardResponsePayment] = None
    __properties: ClassVar[List[str]] = ["code", "message", "payment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payment": CollectChargeViaBankAccountCreditCardResponsePayment.from_dict(obj["payment"]) if obj.get("payment") is not None else None
        })
        return _obj
