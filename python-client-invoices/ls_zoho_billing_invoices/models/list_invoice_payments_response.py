...
class ListInvoicePaymentsResponse(BaseModel):
    ...
    payments: Optional[List[ListInvoicePaymentsResponsePaymentsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "payments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payments": [ListInvoicePaymentsResponsePaymentsInner.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None
        })
        return _obj
