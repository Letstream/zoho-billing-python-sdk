...
class GetPaymentReminderMailContentResponse(BaseModel):
    """
    GetPaymentReminderMailContentResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    data: Optional[GetPaymentReminderMailContentResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetPaymentReminderMailContentResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
