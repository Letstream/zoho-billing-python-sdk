...
class ListInvoiceTemplatesResponseTemplatesInner(BaseModel):
    """
    ...
    template_type: Optional[StrictStr] = Field(default=None, description="The type of template type")
    __properties: ClassVar[List[str]] = ["template_name", "template_id", "template_type"]
