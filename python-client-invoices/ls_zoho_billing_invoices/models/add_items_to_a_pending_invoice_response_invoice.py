...
class AddItemsToAPendingInvoiceResponseInvoice(BaseModel):
    """
    ...
    invoice_items: Optional[List[AddItemsToAPendingInvoiceResponseInvoiceInvoiceItemsInner]] = Field(default=None, description="The list of items which are all included in the invoice. Each item object will have <code>item_id</code>, <code>name</code>, <code>code</code>, <code>price</code>, <code>quantity</code> and <code>item_total</code>. description: Small description about the Invoice item. example: \"Charges for this duration (from 16-April-2016 to 8-June-2016)\"")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "invoice_items": [AddItemsToAPendingInvoiceResponseInvoiceInvoiceItemsInner.from_dict(_item) for _item in obj["invoice_items"]] if obj.get("invoice_items") is not None else None,
