...
class UpdateAddressResponse(BaseModel):
    ...
    invoice_address: Optional[UpdateAddressResponseInvoiceAddress] = None
    __properties: ClassVar[List[str]] = ["code", "message", "invoice_address"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.invoice_address:
            _dict['invoice_address'] = self.invoice_address.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice_address": UpdateAddressResponseInvoiceAddress.from_dict(obj["invoice_address"]) if obj.get("invoice_address") is not None else None
        })
        return _obj
