...
class ListInvoiceTemplatesResponse(BaseModel):
    ...
    templates: Optional[List[ListInvoiceTemplatesResponseTemplatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "templates": [ListInvoiceTemplatesResponseTemplatesInner.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
