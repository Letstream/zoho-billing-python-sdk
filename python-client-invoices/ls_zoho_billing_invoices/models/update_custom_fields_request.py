...
class UpdateCustomFieldsRequest(BaseModel):
    ...
    """ # noqa: E501
    custom_fields: List[UpdateCustomFieldsRequestCustomFieldsInner] = Field(description="Additional fields for the invoices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "custom_fields": [UpdateCustomFieldsRequestCustomFieldsInner.from_dict(_item) for _item in obj["custom_fields"]] if obj.get("custom_fields") is not None else None
        })
        return _obj
