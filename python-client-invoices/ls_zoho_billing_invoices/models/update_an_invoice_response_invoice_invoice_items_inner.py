...
class UpdateAnInvoiceResponseInvoiceInvoiceItemsInner(BaseModel):
    """
    UpdateAnInvoiceResponseInvoiceInvoiceItemsInner
    """ # noqa: E501
    item_id: Optional[StrictStr] = Field(default=None, description="The line item ID")
    product_id: Optional[StrictStr] = Field(default=None, description="The ID of the item included in the invoice.")
    ...
    item_type: Optional[StrictStr] = Field(default=None, description="Enter goods/services")
    ...
    __properties: ClassVar[List[str]] = ["item_id", "product_id", "project_id", "project_name", "item_type", "product_type", "time_entry_ids", "expense_id", "expense_receipt_name", "name", "description", "item_order", "bcy_rate", "price", "quantity", "unit", "discount_amount", "discount", "tax_id", "tds_tax_id", "tax_name", "tax_type", "tax_percentage", "item_total", "sat_item_key_code", "unitkey_code"]
