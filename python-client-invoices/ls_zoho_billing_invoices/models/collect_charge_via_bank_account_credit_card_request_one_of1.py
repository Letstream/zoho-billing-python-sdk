...
class CollectChargeViaBankAccountCreditCardRequestOneOf1(BaseModel):
    """
    CollectChargeViaBankAccountCreditCardRequestOneOf1
    """ # noqa: E501
    card_id: StrictStr = Field(description="Card ID of the card associated with the transaction. If you are collecting charge via bank account, use <code>account_id</code> (Unique ID of the bank account)")
    __properties: ClassVar[List[str]] = ["card_id"]
