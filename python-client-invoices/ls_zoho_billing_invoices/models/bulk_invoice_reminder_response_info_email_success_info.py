...
class BulkInvoiceReminderResponseInfoEmailSuccessInfo(BaseModel):
    """
    Information on success of email delivery
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Alert Message")
    sent_count: Optional[StrictInt] = Field(default=None, description="Number of email s sent")
    __properties: ClassVar[List[str]] = ["message", "sent_count"]
