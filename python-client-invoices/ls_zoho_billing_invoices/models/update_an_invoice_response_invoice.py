...
class UpdateAnInvoiceResponseInvoice(BaseModel):
    """
    ...
    invoice_items: Optional[List[UpdateAnInvoiceResponseInvoiceInvoiceItemsInner]] = Field(default=None, description="Items listed in invoice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice_items": [UpdateAnInvoiceResponseInvoiceInvoiceItemsInner.from_dict(_item) for _item in obj["invoice_items"]] if obj.get("invoice_items") is not None else None,
