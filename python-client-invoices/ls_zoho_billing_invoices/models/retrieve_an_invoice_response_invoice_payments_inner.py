...
class RetrieveAnInvoiceResponseInvoicePaymentsInner(BaseModel):
    """
    ...
    autotransaction: Optional[RetrieveAnInvoiceResponseInvoicePaymentsInnerAutotransaction] = None
    __properties: ClassVar[List[str]] = ["payment_id", "payment_mode", "invoice_payment_id", "amount_refunded", "gateway_transaction_id", "description", "date", "reference_number", "amount", "bank_charges", "exchange_rate", "autotransaction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "autotransaction": RetrieveAnInvoiceResponseInvoicePaymentsInnerAutotransaction.from_dict(obj["autotransaction"]) if obj.get("autotransaction") is not None else None
        })
        return _obj
