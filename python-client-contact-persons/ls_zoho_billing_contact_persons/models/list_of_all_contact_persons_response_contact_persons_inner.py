...
class ListOfAllContactPersonsResponseContactPersonsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["contactperson_id", "first_name", "last_name", "email", "mobile", "phone"]
