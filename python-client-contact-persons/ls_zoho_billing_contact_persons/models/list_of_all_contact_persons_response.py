...
class ListOfAllContactPersonsResponse(BaseModel):
    """
    ListOfAllContactPersonsResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    contact_persons: Optional[List[ListOfAllContactPersonsResponseContactPersonsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "contact_persons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact_persons": [ListOfAllContactPersonsResponseContactPersonsInner.from_dict(_item) for _item in obj["contact_persons"]] if obj.get("contact_persons") is not None else None
        })
        return _obj
