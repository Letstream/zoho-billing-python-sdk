...
class UpdateAContactPersonRequest(BaseModel):
    """
    ...
    email: StrictStr = Field(description="Email ID of the contact person to whom notifications regarding the subscription needs to be sent.")
    ...
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "email", "mobile", "phone", "created_time", "updated_time"]
