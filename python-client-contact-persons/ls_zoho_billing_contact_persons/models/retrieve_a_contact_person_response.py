...
class RetrieveAContactPersonResponse(BaseModel):
    """
    RetrieveAContactPersonResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    contact_person: Optional[RetrieveAContactPersonResponseContactPerson] = None
    __properties: ClassVar[List[str]] = ["code", "message", "contact_person"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.contact_person:
            _dict['contact_person'] = self.contact_person.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact_person": RetrieveAContactPersonResponseContactPerson.from_dict(obj["contact_person"]) if obj.get("contact_person") is not None else None
        })
        return _obj
