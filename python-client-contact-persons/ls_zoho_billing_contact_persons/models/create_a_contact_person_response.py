...
class CreateAContactPersonResponse(BaseModel):
    """
    CreateAContactPersonResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    contact_person: Optional[ContactPersonResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact_person": ContactPersonResponse.from_dict(obj["contact_person"]) if obj.get("contact_person") is not None else None
        })
        return _obj
