...
class ListAllActiveCreditCardsOfACustomerResponse(BaseModel):
    """
    ListAllActiveCreditCardsOfACustomerResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    cards: Optional[List[ListAllActiveCreditCardsOfACustomerResponseCardsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "cards"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cards": [ListAllActiveCreditCardsOfACustomerResponseCardsInner.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None
        })
        return _obj
