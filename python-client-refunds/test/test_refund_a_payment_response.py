...
class TestRefundAPaymentResponse(unittest.TestCase):
    """RefundAPaymentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundAPaymentResponse:
        """Test RefundAPaymentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundAPaymentResponse`
        """
        model = RefundAPaymentResponse()
        if include_optional:
            return RefundAPaymentResponse(
                code = 0,
    ...
    def testRefundAPaymentResponse(self):
        """Test RefundAPaymentResponse"""
