...
class RetrieveRefundDetailsResponse(BaseModel):
    """
    RetrieveRefundDetailsResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    refund: Optional[RefundAPaymentResponseRefund] = None
    __properties: ClassVar[List[str]] = ["code", "message", "refund"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refund": RefundAPaymentResponseRefund.from_dict(obj["refund"]) if obj.get("refund") is not None else None
        })
        return _obj
