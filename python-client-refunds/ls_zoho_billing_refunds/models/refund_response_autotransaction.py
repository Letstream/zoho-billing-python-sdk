...
class RefundResponseAutotransaction(BaseModel):
    """
    ...
    gateway_transaction_id: Optional[StrictStr] = Field(default=None, description="Transaction ID of the gateway associated with payment.")
    gateway_error_message: Optional[StrictStr] = Field(default=None, description="Gateway error for a failed transaction.")
    card_id: Optional[StrictStr] = Field(default=None, description="Card ID of the card.")
