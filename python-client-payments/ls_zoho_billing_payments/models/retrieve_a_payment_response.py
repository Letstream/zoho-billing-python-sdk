...
class RetrieveAPaymentResponse(BaseModel):
    """
    RetrieveAPaymentResponse
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    payment: Optional[RetrieveAPaymentResponsePayment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payment": RetrieveAPaymentResponsePayment.from_dict(obj["payment"]) if obj.get("payment") is not None else None
        })
        return _obj
