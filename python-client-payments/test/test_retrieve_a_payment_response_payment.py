...
class TestRetrieveAPaymentResponsePayment(unittest.TestCase):
    """RetrieveAPaymentResponsePayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveAPaymentResponsePayment:
        """Test RetrieveAPaymentResponsePayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveAPaymentResponsePayment`
        """
        model = RetrieveAPaymentResponsePayment()
        if include_optional:
            return RetrieveAPaymentResponsePayment(
    ...
    def testRetrieveAPaymentResponsePayment(self):
        """Test RetrieveAPaymentResponsePayment"""
